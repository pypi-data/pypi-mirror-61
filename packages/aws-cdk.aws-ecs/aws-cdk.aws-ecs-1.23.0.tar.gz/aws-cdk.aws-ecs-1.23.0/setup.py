...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-autoscaling==1.23.0",
        "aws-cdk.aws-autoscaling-hooktargets==1.23.0",
        ...
        "aws-cdk.aws-ecr==1.23.0",
        "aws-cdk.aws-ecr-assets==1.23.0",
        "aws-cdk.aws-elasticloadbalancing==1.23.0",
        ...
        "aws-cdk.aws-secretsmanager==1.23.0",
