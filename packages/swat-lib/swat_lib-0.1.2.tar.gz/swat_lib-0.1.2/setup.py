import setuptools
setuptools.setup(
  name = 'swat_lib',         # How you named your package folder (MyLib)
  packages = ['swat_lib'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/serato/swat-lib/archive/v0.1.2.tar.gz',
