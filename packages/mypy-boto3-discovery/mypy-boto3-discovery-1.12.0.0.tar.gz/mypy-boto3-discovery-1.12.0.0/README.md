...
[boto3.ApplicationDiscoveryService 1.12.0](https://boto3.amazonaws.com/v1/documentation/api/1.12.0/reference/services/discovery.html#ApplicationDiscoveryService) service
