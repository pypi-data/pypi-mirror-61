...
[boto3.ApplicationDiscoveryService 1.12.2](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/discovery.html#ApplicationDiscoveryService) service
