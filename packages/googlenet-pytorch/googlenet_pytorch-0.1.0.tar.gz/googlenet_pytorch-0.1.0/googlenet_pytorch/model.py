...
urls_map = {
  ...
  'googlenet_pytorch': 'https://download.pytorch.org/models/googlenet-1378be20.pth',
}
...
def googlenet(pretrained=True, progress=True, **kwargs):
  ...
  if pretrained:
    ...
    if kwargs['aux_logits']:
      warnings.warn('auxiliary heads in the pretrained googlenet_pytorch model are NOT pretrained, '
                    'so make sure to train them')
    original_aux_logits = kwargs['aux_logits']
    kwargs['aux_logits'] = True
    kwargs['init_weights'] = False
    state_dict = model_zoo.load_url(urls_map['googlenet_pytorch'])
