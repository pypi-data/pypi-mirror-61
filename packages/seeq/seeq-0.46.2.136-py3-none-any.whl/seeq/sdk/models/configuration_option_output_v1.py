...
class ConfigurationOptionOutputV1(object):
    ...
    def __init__(self, advanced=False, allowed_values=None, default_description=None, default_value=None, description=None, modifiable=False, note=None, path=None, registration=None, registration_description=None, units=None, value=None):
        """
