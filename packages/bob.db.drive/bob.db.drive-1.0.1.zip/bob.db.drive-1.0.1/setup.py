...
setup(
    ...
    description='DRIVE Database Access API for Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.drive',
    license='BSD',
    ...
    keywords = "retinal vessel segmentation, bob, bob.db, drive",
    ...
    entry_points={
      ...
      'bob.db': [
        'drive = bob.db.drive.driver:Interface',
      ],
      },
