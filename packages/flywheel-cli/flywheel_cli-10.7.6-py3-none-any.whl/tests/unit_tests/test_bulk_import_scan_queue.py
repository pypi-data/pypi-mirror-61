...
def test_scan_queue_create(db_type, ingest_factory):
    factory = ingest_factory(db_type)

    queue = factory.create_scan_queue_mapper()
...
def test_scan_queue_insert(db_type, ingest_factory):
    factory = ingest_factory(db_type)
    queue = factory.create_scan_queue_mapper()
...
def test_scan_queue_get(db_type, ingest_factory):
    factory = ingest_factory(db_type)
    queue = factory.create_scan_queue_mapper()
...
def test_scan_queue_update(db_type, ingest_factory):
    factory = ingest_factory(db_type)
    queue = factory.create_scan_queue_mapper()
...
def test_bulk_import_scan_queue_is_complete(db_type, ingest_factory):
    factory = ingest_factory(db_type)
    queue = factory.create_scan_queue_mapper()
...
def test_bulk_import_scan_queue_is_complete_ingest(db_type, ingest_factory):
    factory = ingest_factory(db_type)
    queue = factory.create_scan_queue_mapper()
