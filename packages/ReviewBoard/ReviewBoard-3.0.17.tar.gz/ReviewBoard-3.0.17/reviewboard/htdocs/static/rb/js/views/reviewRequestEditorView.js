    ...
    RB.ReviewRequestEditorView = Backbone.View.extend({
        ...
        render: function render() {
            ...
            fileAttachments.each(function (fileAttachment) {
                return _this3.buildFileAttachmentThumbnail(fileAttachment, fileAttachments, { noAnimation: true });
            });
        ...
        _resizeLayout: function _resizeLayout() {
             ...
             */
            this._$main.height(this._$extra.offset().top - this._$main.offset().top);
        ...
        _onDeleteReviewRequestClicked: function _onDeleteReviewRequestClicked() {
            ...
            var $dlg = $('<p>').text(gettext('This deletion cannot be undone. All diffs and reviews will be deleted as well.')).modalBox({
                ...
                buttons: [$('<input type="button" value="' + gettext('Cancel') + '"/>'), $('<input type="button" value="' + gettext('Delete') + '"/>').click(function () {
        ...
        _updateArchiveVisibility: function _updateArchiveVisibility() {
            ...
            var iconClass = visibility === RB.ReviewRequest.VISIBILITY_VISIBLE ? 'rb-icon-archive-off' : 'rb-icon-archive-on';

            this.$('#hide-review-request-link').html('<span class="rb-icon ' + iconClass + '"></span>');
        },
