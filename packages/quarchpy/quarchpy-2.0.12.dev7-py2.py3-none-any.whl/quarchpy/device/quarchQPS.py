...
class quarchStream(quarchQPS):
    ...
    def addCustomAnnotation(self, text="", yPos="", textColor="", color="", userType="", annotaionTime=0):
        annotationString = "<"
        ...
        if text != "":
            annotationString+="<text>"+text +"</text>"
        if yPos != "":
            annotationString+="<yPos>"+yPos +"</yPos>"
        if textColor != "":
            annotationString+="<textColor>"+textColor +"</textColor>"
        if color != "":
            annotationString+="<color>"+color +"</color>"
        if userType != "":
            annotationString+="<userType>"+userType +"</userType>"
        annotationString+=">"
