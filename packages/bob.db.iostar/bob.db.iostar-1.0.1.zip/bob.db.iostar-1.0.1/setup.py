...
setup(
    ...
    description='IOSTAR Database Access API for Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.iostar',
    license='BSD',
    ...
    keywords = "retinal vessel segmentation, bob, bob.db, iostar",
    ...
    entry_points={
      ...
      'bob.db': [
        'iostar = bob.db.iostar.driver:Interface',
      ],
      },
