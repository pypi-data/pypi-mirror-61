...
class WS28xxDriver(AbstractDevice):
    ...
    def genLoopPackets(self):
        ...
        while self._service.isRunning():
            ...
            raise WeeWxIOError('RF thread is not running')
...
#        pass
    ...
    def get_observation(self):
        ...
        rain_total = get_datum_match(data._RainTotal,
                                     CWeatherTraits.RainNP(),
                                     CWeatherTraits.RainOFL())
        delta = rain_total - self._last_rain
...
class sHID(object):
    ...
    def open(self, vid, pid, did, serial):
        ...
        if device is None:
            ...
            raise WeeWxIOError('Unable to find transceiver on USB')
