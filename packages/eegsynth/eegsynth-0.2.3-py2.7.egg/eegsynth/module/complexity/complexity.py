...
try:
    ...
    # It is only used inside this EEGsynth complexity module, hence it is not installed automatically
    from neurokit.signal import complexity
except ModuleNotFoundError:
    print('Warning: neurokit is required for the complexity module, but not installed')
