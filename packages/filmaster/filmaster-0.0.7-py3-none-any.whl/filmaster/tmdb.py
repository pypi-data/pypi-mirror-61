...
from typing import List, NamedTuple, Optional as Opt, SupportsInt as SInt
...
def get_film(*, film: Opt[str] = None,
    ...
    if film:
        ...
        try:
            res = choice(list(api.discover_movies({  # nosec
...
def get_random() -> str:
    ...
    :return: The default title of the movie.
    """
    return choice(list(api.discover_movies({  # nosec
        'with_keywords': '310', 'vote_average.gte': 7.5
    }))).title['default']


__all__ = [
    'TMDB_URL', 'ApiError', 'Person', 'Film',
    'get_film', 'get_cast', 'get_random', 'api'
]
