...
def load_config_to_env(ref: str, config_url: str = 'http://buscamax-data.buscamilhas.com', force_az: str = None):
    ...
    config: dict = requests.get(f"{config_url}/{ambient}/{az}/{ref}").json()
