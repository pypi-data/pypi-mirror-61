...
# -*- coding: utf-8 -*-
#
# widget_code_input documentation build configuration file
#
...
copyright = '2020, Giovanni Pizzi, Dou Du'
...
_version_py = os.path.join(repo, 'widget_code_input', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'widget_code_inputdoc'
