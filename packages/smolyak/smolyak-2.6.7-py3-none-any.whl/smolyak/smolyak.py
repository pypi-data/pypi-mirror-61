...
class _Estimator:
    ...
    def __call__(self, mi):
        ...
        if mi in self.quantities:
            ...
            if mi.is_kronecker() and MultiIndex() in self.quantities:
                ...
                return estimate if estimate > 0 else 1  # Avoid divide by zero, should at most happen for estimate of [] anyway.
...
class _Data:
    ...
    def apriori_indices(self,L):
        ...
        try:
            return get_admissible_indices(lambda mi: admissible(mi), self.decomposition.n)
        except KeyError:
