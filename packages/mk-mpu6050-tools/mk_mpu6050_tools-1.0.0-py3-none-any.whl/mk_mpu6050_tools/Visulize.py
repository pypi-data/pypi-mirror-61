...
class __model__loader__(object):
    ...
    @property
    def DRONE(self):
        path = os.path.abspath(os.path.join(os.path.split(__file__)[0], "Models", "Drone.egg"))
        shutil.copyfile(path, os.path.join(".", os.path.split(path)[1]))
        return "Drone.egg"

    @property
    def RECTANGLE(self):
        path = os.path.abspath(os.path.join(os.path.split(__file__)[0], "Models", "Rectangle.egg"))
        shutil.copyfile(path, os.path.join(".", os.path.split(path)[1]))
        return "Rectangle.egg"

    @property
    def TRUCK(self):
        path = os.path.abspath(os.path.join(os.path.split(__file__)[0], "Models", "Truck.egg"))
        shutil.copyfile(path, os.path.join(".", os.path.split(path)[1]))
        return "Truck.egg"

    @property
    def PLANE(self):
        path = os.path.abspath(os.path.join(os.path.split(__file__)[0], "Models", "Plane.egg"))
        shutil.copyfile(path, os.path.join(".", os.path.split(path)[1]))
        return "Plane.egg"

    @property
    def GRYO_MULTIPLEX(self):
        path = os.path.abspath(os.path.join(os.path.split(__file__)[0], "Models", "GyroBase.egg"))
        shutil.copyfile(path, os.path.join(".", os.path.split(path)[1]))
        path = os.path.abspath(os.path.join(os.path.split(__file__)[0], "Models", "GyroSpin.egg"))
        shutil.copyfile(path, os.path.join(".", os.path.split(path)[1]))
...
def Run_visiulization_on_Gyro(Gyro, model=MODELS.GRYO_MULTIPLEX, use_offset=True):
