...
def find_all_onsets_and_peaks_on_fluorescence_signal(smooth_trace, threshold_factor=0.5):
    """
...
def check_one_tiff_file_by_frame_exists(identifiers, results_path):
    """
