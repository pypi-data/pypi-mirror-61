...
def test_knotnet_directly():
    ...
    expected = read_KnotProt_matrix('data/KNOTS_2efv_A')
...
def test_matrix_plot():
    ...
    for cutoff in cutoffs:
        ...
        conway('data/1j85.pdb', matrix=True, tries=10, plot_ofile=ofile, matrix_cutoff=cutoff, translate=True)
    ...
    plot_matrix(matrix_output_file, plot_ofile=plot_ofile_protein)
