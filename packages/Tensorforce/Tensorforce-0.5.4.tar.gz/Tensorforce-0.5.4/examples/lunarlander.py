...
def main():
    ...
    for n in range(10):
        ...
        environment = OpenAIGym('LunarLander-v2')
        ...
        agent = PPO(
            ...
            batch_size=6, update_frequency=1, learning_rate=0.00241198062219515,
            subsampling_fraction=0.7480937160673563, optimization_steps=8,
            likelihood_ratio_clipping=0.05759224272026257, discount=0.9867338365100885,
            estimate_terminal=False,
            critic_network=[dict(type='dense', size=32), dict(type='dense', size=32)],
            critic_optimizer=dict(
                type='multi_step', optimizer=dict(type='adam', learning_rate=0.0005950514373857032),
                num_steps=15
            ),
            entropy_regularization=0.0063059537871772535
        )
    ...
    plt.savefig(os.path.join('examples', 'lunarlander.png'))
