...
import harpo
from harpo import Harpo
from harpo.exceptions import HarpoAlreadyInitialized, HarpoUserNotFound, HarpoDomainAlreadyExists
from harpo.logging import get_logger
from harpo.util import with_lock


class Exporter(object):
    def __init__(self, src_base_dir, dst_base_dir, gpg_home):
    ...
    def export_domain(self, domain_name, recurse=True):
        ...
        for key in domain.secrets.list():
            self.logger.info("Exporting secret %s::%s", domain_name, key)
