...
@with_harpo_context
def create(harpo: Harpo, common_parameters, force, domain_name, secret_name, secret_value):
    """Create a new secret
...
@with_harpo_context
def read(harpo: Harpo, common_parameters, domain_name, secret_name):
...
@click.argument('secret_name', autocompletion=complete_secret_name)
@with_harpo_context
def destroy(harpo: Harpo, common_parameters, domain_name, secret_name):
...
@click.argument('domain_name', autocompletion=complete_domain_name)
@with_harpo_context
def list(harpo: Harpo, common_parameters, domain_name):
...
@click.argument('secret_name', autocompletion=complete_secret_name)
@with_harpo_context
def edit(harpo: Harpo, common_parameters, domain_name, secret_name):
