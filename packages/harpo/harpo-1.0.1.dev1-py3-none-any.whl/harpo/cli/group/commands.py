...
@with_harpo_context
def create(harpo: Harpo, common_parameters, group_name):
...
@with_harpo_context
def destroy(harpo: Harpo, common_parameters, group_name):
...
@with_harpo_context
def include_user(harpo: Harpo, common_parameters, group_name, user_name):
    """Add user to group"""
...
@click.argument('user_name', autocompletion=complete_user_name)
@with_harpo_context
def exclude_user(harpo: Harpo, common_parameters, group_name, user_name):
