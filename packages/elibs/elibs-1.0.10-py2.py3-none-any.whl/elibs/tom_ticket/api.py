...
class TomTicket:
    ...
    def get_chamados(self, page=1):
        url = f"{self.url}/chamados/{self.token}/{page}"
        response = requests.get(url)
        return dict_to_prop(response.json())

    def get_chamado(self, chamado):
    ...
    def get_cliente(self, identificador, tipo_identificador='E'):
    ...
    def criar_organizacao(self, nome, email='', telefone='', criar_chamados=False, chamadosgerente=False,
