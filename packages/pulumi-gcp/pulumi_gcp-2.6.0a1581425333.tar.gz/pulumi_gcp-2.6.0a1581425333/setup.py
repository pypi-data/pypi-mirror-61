...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.6.0-alpha.1581425333+g84d6e20f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.6.0-alpha.1581425333+g84d6e20f`
                """)
            else:
                raise
