...
requires = [
    "django",
    "django-static-fontawesome>=5.12.1",
]
...
setup(
    ...
    packages=find_packages(".", exclude=["changelist_toolbar_example", "changelist_toolbar_example.migrations", "changelist_toolbar_demo"]),
    py_modules=["changelist_toolbar"],
    zip_safe=False,
