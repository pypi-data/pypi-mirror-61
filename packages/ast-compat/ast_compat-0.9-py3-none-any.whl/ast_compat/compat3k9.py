...
class Module(metaclass=SupertypeMeta):
    __past__ = ast.Module
    def __new__(self, body=None, type_ignores=None):
        """start checking validation"""
        if body is None: body = []
        if type_ignores is None: type_ignores = []
...
class FunctionType(metaclass=SupertypeMeta):
    ...
    def __new__(self, argtypes=None, returns=None):
        """start checking validation"""
        if argtypes is None: argtypes = []
        if returns is None: raise ValueError('returns cannot be None.')
...
class FunctionDef(metaclass=SupertypeMeta):
    ...
    def __new__(self, name=None, args=None, body=None, decorator_list=None, returns=None, type_comment=None):
        """start checking validation"""
...
class Assign(metaclass=SupertypeMeta):
    __past__ = ast.Assign
    def __new__(self, targets=None, value=None, type_comment=None):
        """start checking validation"""
        if targets is None: targets = []
...
class For(metaclass=SupertypeMeta):
    __past__ = ast.For
    def __new__(self, target=None, iter=None, body=None, orelse=None, type_comment=None):
        """start checking validation"""
        if target is None: raise ValueError('target cannot be None.')
...
class With(metaclass=SupertypeMeta):
    __past__ = ast.With
    def __new__(self, items=None, body=None, type_comment=None):
        """start checking validation"""
...
class NamedExpr(metaclass=SupertypeMeta):
    ...
    def __new__(self, target=None, value=None):
        """start checking validation"""
        if target is None: raise ValueError('target cannot be None.')
        if value is None: raise ValueError('value cannot be None.')
...
class Constant(metaclass=SupertypeMeta):
    ...
    def __new__(self, value=None, kind=None):
        """start checking validation"""
        if value is None: raise ValueError('value cannot be None.')
...
class arguments(metaclass=SupertypeMeta):
    ...
    def __new__(self, posonlyargs=None, args=None, vararg=None, kwonlyargs=None, kw_defaults=None, kwarg=None, defaults=None):
        """start checking validation"""
...
class arg(metaclass=SupertypeMeta):
    __past__ = ast.arg
    def __new__(self, arg=None, annotation=None, type_comment=None):
        """start checking validation"""
...
class TypeIgnore(metaclass=SupertypeMeta):
    ...
    def __new__(self, lineno=None, tag=None):
        """start checking validation"""
        if lineno is None: raise ValueError('lineno cannot be None.')
        if tag is None: raise ValueError('tag cannot be None.')
