...
class Resource(BaseRefHierarcy):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['location'], condition=Q(calendar=None), name='Resource_unique_constraint_0'),
            UniqueConstraint(fields=['calendar', 'location'], name='Resource_unique_constraint_1'),
        ]
