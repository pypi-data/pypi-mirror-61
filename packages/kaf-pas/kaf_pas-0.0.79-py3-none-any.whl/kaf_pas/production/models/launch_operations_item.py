...
class Launch_operations_item(Hierarcy):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['item', 'launch'], condition=Q(num=None), name='Launch_operations_item_unique_constraint_0'),
            UniqueConstraint(fields=['item', 'launch', 'num'], name='Launch_operations_item_unique_constraint_1'),
        ]
