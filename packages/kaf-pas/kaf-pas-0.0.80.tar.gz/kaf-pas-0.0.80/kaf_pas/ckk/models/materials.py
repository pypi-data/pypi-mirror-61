...
class Materials(BaseRefHierarcy):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['gost', 'location', 'materials_type'], condition=Q(nomenklatura_model=None), name='Materials_unique_constraint_0'),
            UniqueConstraint(fields=['gost', 'location', 'materials_type', 'nomenklatura_model'], name='Materials_unique_constraint_1'),
        ]
