...
class Launch_operations_item(Hierarcy):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['item', 'launch', 'operation'], condition=Q(num=None), name='Launch_operations_item_unique_constraint_0'),
            UniqueConstraint(fields=['item', 'launch', 'num', 'operation'], name='Launch_operations_item_unique_constraint_1'),
        ]
