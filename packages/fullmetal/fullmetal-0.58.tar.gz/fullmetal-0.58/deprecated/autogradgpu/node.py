...
import cupy as cp
from autogradgpu.math_operations import Sum, Add, MatMul, Mul, Sub, Div, Neg, Exp, Max
from autogradgpu.tensor_modifications import Slice, T, Reshape, Pad
from autogradgpu.dependency import Dependency
from autogradgpu.engin import  autogradgpu
...
class Node(object):
    ...
    def backward(self, grad: "Node" = None) -> None:
        autogradgpu(self).backward(grad) # apply backward function wrapping the output gardent
