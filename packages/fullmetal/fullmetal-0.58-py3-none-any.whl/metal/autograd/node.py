...
import numpy as np
from metal.autograd.math_operations import Sum, Add, MatMul, Mul, Sub, Div, Neg, Exp, Max
from metal.autograd.tensor_modifications import Slice, T, Reshape, Pad
from metal.autograd.dependency import Dependency
from metal.autograd.engin import  metal.autograd
...
class Node(object):
    ...
    def backward(self, grad: "Node" = None) -> None:
        metal.autograd(self).backward(grad) # apply backward function wrapping the output gardent
