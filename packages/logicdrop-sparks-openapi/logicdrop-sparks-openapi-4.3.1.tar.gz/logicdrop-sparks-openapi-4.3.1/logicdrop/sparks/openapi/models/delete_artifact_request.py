...
class DeleteArtifactRequest(object):
    ...
    def __init__(self, ids=None, local_vars_configuration=None):  # noqa: E501
        """DeleteArtifactRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def ids(self):
        """Gets the ids of this DeleteArtifactRequest.  # noqa: E501

        ID(s) to process  # noqa: E501

        :return: The ids of this DeleteArtifactRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this DeleteArtifactRequest.

        ID(s) to process  # noqa: E501

        :param ids: The ids of this DeleteArtifactRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteArtifactRequest):
            return False
