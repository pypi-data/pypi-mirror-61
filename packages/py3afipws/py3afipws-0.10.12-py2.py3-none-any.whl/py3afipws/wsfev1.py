...
"""Módulo para obtener CAE/CAEA, código de autorización electrónico
webservice WSFEv1 de AFIP (Factura Electrónica Nacional - Proyecto
Version 1 - 2.10) Según RG 2485/08, RG 2757/2010, RG 2904/2010 y
...
destino casa habitación). RG 4109-E Venta de bienes muebles registrables.
Más info:
...
class WSFEv1(BaseWS):
    ...
    def AgregarCmpAsoc(
            self, tipo=1, pto_vta=0, nro=0, cuit=None, fecha=None, **kwarg):
    ...
    def ParamGetTiposTributos(self, sep="|"):
        """Recuperador de valores referenciales de códigos de Tipos de
        Tributos Este método permite consultar los tipos de tributos
    ...
    def ParamGetTiposPaises(self, sep="|"):
        ...
        Este método permite consultar los tipos de tributos habilitados en
        este WS"""
        log.warn("### Calling Recuperador de valores referenciales de \
                 codigos de Paises")
    ...
    def ParamGetCotizacion(self, moneda_id):
        ...
        log.warn("### Recuperador de cotización de moneda \
    ...
    def ParamGetPtosVenta(self, sep="|"):
        ...
        Facturación Electronica que soporten CAE y CAEA via Web Services \
        (FEParamGetPtosVenta)")
