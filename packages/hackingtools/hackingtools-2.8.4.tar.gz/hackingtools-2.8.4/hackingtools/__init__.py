...
if __telegrambot_name__ and __telegrambot_token__:
    worker('telegram-bot-{name}'.format(name=__telegrambot_name__), 'ht.core.Objects.TelegramBotCoreHT', args=(__telegrambot_name__, __telegrambot_token__), timesleep=10, log=__amidjango__)
