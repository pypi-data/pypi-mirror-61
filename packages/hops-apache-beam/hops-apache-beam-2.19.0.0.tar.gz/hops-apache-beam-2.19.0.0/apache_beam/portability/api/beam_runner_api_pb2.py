...
_WIRECODERSETTING = _descriptor.Descriptor(
  name='WireCoderSetting',
  full_name='org.apache.beam.model.pipeline.v1.WireCoderSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='urn', full_name='org.apache.beam.model.pipeline.v1.WireCoderSetting.urn', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='payload', full_name='org.apache.beam.model.pipeline.v1.WireCoderSetting.payload', index=1,
...
_EXECUTABLESTAGEPAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='wire_coder_setting', full_name='org.apache.beam.model.pipeline.v1.ExecutableStagePayload.wire_coder_setting', index=1,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXECUTABLESTAGEPAYLOAD.fields_by_name['wire_coder_setting'].message_type = _WIRECODERSETTING
...
DESCRIPTOR.message_types_by_name['WireCoderSetting'] = _WIRECODERSETTING
...
WireCoderSetting = _reflection.GeneratedProtocolMessageType('WireCoderSetting', (_message.Message,), dict(
  DESCRIPTOR = _WIRECODERSETTING,
  __module__ = 'beam_runner_api_pb2'
  # @@protoc_insertion_point(class_scope:org.apache.beam.model.pipeline.v1.WireCoderSetting)
  ))
_sym_db.RegisterMessage(WireCoderSetting)
