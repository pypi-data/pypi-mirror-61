...
with open('ucla_subgraph_matching/__init__.py', 'r') as f:
    for line in f:
...
kwargs = {
    ...
    'maintainer': 'Jacob Moorman',
    'maintainer_email': 'jdmoorman@math.ucla.edu',
    'url': 'https://github.com/_/ucla-subgraph-matching',
    'license': 'MIT',
    'classifiers': [
