...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.14.0-alpha.1581534667+g4f3be41b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.14.0-alpha.1581534667+g4f3be41b`
                """)
            else:
                raise
