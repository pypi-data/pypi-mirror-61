...
using Velocity = typename frc::ProfiledPIDController<Distance>::Velocity;
    ...
    cls_ProfiledPIDController
      ...
      py::arg("Kp"), py::arg("Ki"), py::arg("Kd"), py::arg("constraints"), py::arg("period")=20_ms, release_gil(),
      ...
      py::arg("Kp"), py::arg("Ki"), py::arg("Kd"), release_gil(),
      ...
      py::arg("Kp"), release_gil(),
      "Sets the proportional coefficient of the PID controller gain.\n"
      "\n"
      ":param Kp: proportional coefficient")
    
      .def("setI", &frc::ProfiledPIDController<Distance>::SetI,
      py::arg("Ki"), release_gil(),
      "Sets the integral coefficient of the PID controller gain.\n"
      "\n"
      ":param Ki: integral coefficient")
    
      .def("setD", &frc::ProfiledPIDController<Distance>::SetD,
      py::arg("Kd"), release_gil(),
      "Sets the differential coefficient of the PID controller gain.\n"
      "\n"
      ":param Kd: differential coefficient")
    
      .def("getP", &frc::ProfiledPIDController<Distance>::GetP, release_gil(),
      "Gets the proportional coefficient.\n"
      "\n"
      ":returns: proportional coefficient")
    
      .def("getI", &frc::ProfiledPIDController<Distance>::GetI, release_gil(),
      "Gets the integral coefficient.\n"
      "\n"
      ":returns: integral coefficient")
    
      .def("getD", &frc::ProfiledPIDController<Distance>::GetD, release_gil(),
      "Gets the differential coefficient.\n"
      "\n"
      ":returns: differential coefficient")
    
      .def("getPeriod", &frc::ProfiledPIDController<Distance>::GetPeriod, release_gil(),
...
&frc::ProfiledPIDController<Distance>::SetGoal),
      ...
      .def("getGoal", &frc::ProfiledPIDController<Distance>::GetGoal, release_gil(),
      "Gets the goal for the ProfiledPIDController.")
    
      .def("atGoal", &frc::ProfiledPIDController<Distance>::AtGoal, release_gil(),
      "Returns true if the error is within the tolerance of the error.\n"
      "\n"
      "This will return false until at least one input value has been computed.")
    
      .def("setConstraints", &frc::ProfiledPIDController<Distance>::SetConstraints,
      py::arg("constraints"), release_gil(),
      "Set velocity and acceleration constraints for goal.\n"
      "\n"
      ":param constraints: Velocity and acceleration constraints for goal.")
    
      .def("getSetpoint", &frc::ProfiledPIDController<Distance>::GetSetpoint, release_gil(),
      "Returns the current setpoint of the ProfiledPIDController.\n"
      "\n"
      ":returns: The current setpoint.")
    
      .def("atSetpoint", &frc::ProfiledPIDController<Distance>::AtSetpoint, release_gil(),
      "Returns true if the error is within the tolerance of the error.\n"
      "\n"
      ...
      py::arg("minimumInput"), py::arg("maximumInput"), release_gil(),
      ...
      .def("disableContinuousInput", &frc::ProfiledPIDController<Distance>::DisableContinuousInput, release_gil(),
      "Disables continuous input.")
    
      .def("setIntegratorRange", &frc::ProfiledPIDController<Distance>::SetIntegratorRange,
      py::arg("minimumIntegral"), py::arg("maximumIntegral"), release_gil(),
      ...
      py::arg("positionTolerance"), py::arg("velocityTolerance")=std::numeric_limits<double >::infinity ( ), release_gil(),
      ...
      .def("getPositionError", &frc::ProfiledPIDController<Distance>::GetPositionError, release_gil(),
      "Returns the difference between the setpoint and the measurement.\n"
      "\n"
      ":returns: The error.")
    
      .def("getVelocityError", &frc::ProfiledPIDController<Distance>::GetVelocityError, release_gil(),
...
&frc::ProfiledPIDController<Distance>::Calculate),
      py::arg("measurement"), release_gil(),
...
&frc::ProfiledPIDController<Distance>::Calculate),
      py::arg("measurement"), py::arg("goal"), release_gil(),
      "Returns the next output of the PID controller.\n"
      "\n"
      ":param measurement: The current measurement of the process variable.\n"
      "\n"
...
&frc::ProfiledPIDController<Distance>::Calculate),
      py::arg("measurement"), py::arg("goal"), py::arg("constraints"), release_gil(),
      "Returns the next output of the PID controller.\n"
      "\n"
      ":param measurement: The current measurement of the process variable.\n"
      "\n"
...
&frc::ProfiledPIDController<Distance>::Reset),
      py::arg("measuredPosition"), py::arg("measuredVelocity"), release_gil(),
      "Reset the previous error and the integral term.\n"
      "\n"
...
&frc::ProfiledPIDController<Distance>::Reset),
      py::arg("measuredPosition"), release_gil(),
      "Reset the previous error and the integral term.\n"
      "\n"
