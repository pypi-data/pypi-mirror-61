...
class _PoolNd(Layer):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True,padding_mode=PaddingMode.replicate, dilation=1,name='', **kwargs):
...
class MaxPool1d(_PoolNd):
    ...
    def __init__(self, kernel_size, strides=None, auto_pad=True,padding_mode=PaddingMode.replicate,name='', **kwargs):
...
class MaxPool2d(_PoolNd):
    ...
    .. _link:
        https://github.com/vdumoulin/conv_arithmetic/blob/master/README.md
    """
    def __init__(self, kernel_size, strides=None, auto_pad=True,padding_mode=PaddingMode.zero, name='',**kwargs):
