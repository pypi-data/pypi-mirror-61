    ...
    def infer_single_image(self,img,**kwargs):
        if self.model.built:
            ...
            if len(boxes_list) > 0:
                ...
                boxes =nms(boxes, threshold=0.9,image_size=(img.shape[0],img.shape[1]),min_size=self.min_size)
                ...
                if boxes is not None:
                    ...
                    boxes=nms(boxes,  threshold=0.7,image_size=(img.shape[0],img.shape[1]),min_size=self.min_size)
                    ...
                    #########onet finish
                    #######################################
                    boxes=nms(boxes, threshold=0.3,image_size=(img.shape[0],img.shape[1]),min_size=self.min_size)
