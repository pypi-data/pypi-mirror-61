...
effb0_old=torch.load('C:/Users/Allan/Downloads/efficientnet-b0.pth')
effb0=EfficientNetB0(pretrained=False)
effb0_old.cpu()
effb0.model.cpu()
effb0.model.trainable=True

paras_old=list(effb0_old.named_parameters())
paras=list(effb0.model.named_parameters())

print('paras_old',len(paras_old))
print('paras',len(paras))

buffer_old=list(effb0_old.named_buffers())
buffer=list(effb0.model.named_buffers())
...
effb0.save_onnx('efficientnet-b0.onnx')

#
# example = torch.rand(1, 3, 224, 224).cuda()
#
# traced_script_module = torch.jit.trace(effb0.model, example)
...
#
#
# effb0=EfficientNet(1.0, 1.1, 240, 0.2, model_name='efficientnet-b0',include_top=True,num_classes=1000)
...
#
#
# effnetb0=torch.load('C:/Users/Allan/Downloads/efficientnet-b0.pth')
