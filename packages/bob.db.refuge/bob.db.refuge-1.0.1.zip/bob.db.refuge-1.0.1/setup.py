...
setup(
    ...
    description='REFUGE Database Access API for Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.refuge',
    license='BSD',
    ...
    keywords = "optic disc segmentation, bob, bob.db, refuge",
    ...
    entry_points={
      ...
      'bob.db': [
        'refuge = bob.db.refuge.driver:Interface',
      ],
      },
