...
def __touchup__(cls, parent):
    ...
    try:
        ...
        type_value = cls.__decipher__(value=variable_type_member, structure=parent)
...
class TypeMember(Member):
    ...
    def __init__(self, *, mapping, cls=None, ignore=False, decipher=None):
