...
class PollyClient:
    """
    [Polly.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.can_paginate)
        """

    def delete_lexicon(self, Name: str) -> Dict[str, Any]:
        """
        [Client.delete_lexicon documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.delete_lexicon)
        """
    ...
    def describe_voices(
        ...
        """
        [Client.describe_voices documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.describe_voices)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.generate_presigned_url)
        """

    def get_lexicon(self, Name: str) -> ClientGetLexiconResponseTypeDef:
        """
        [Client.get_lexicon documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.get_lexicon)
        """

    def get_speech_synthesis_task(self, TaskId: str) -> ClientGetSpeechSynthesisTaskResponseTypeDef:
        """
        [Client.get_speech_synthesis_task documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.get_speech_synthesis_task)
        """

    def list_lexicons(self, NextToken: str = None) -> ClientListLexiconsResponseTypeDef:
        """
        [Client.list_lexicons documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.list_lexicons)
        """
    ...
    def list_speech_synthesis_tasks(
        ...
        """
        [Client.list_speech_synthesis_tasks documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.list_speech_synthesis_tasks)
        """

    def put_lexicon(self, Name: str, Content: str) -> Dict[str, Any]:
        """
        [Client.put_lexicon documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.put_lexicon)
        """
    ...
    def start_speech_synthesis_task(
        ...
        """
        [Client.start_speech_synthesis_task documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.start_speech_synthesis_task)
        """
    ...
    def synthesize_speech(
        ...
        """
        [Client.synthesize_speech documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Client.synthesize_speech)
        """
    ...
    def get_paginator(
        ...
        """
        [Paginator.DescribeVoices documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Paginator.DescribeVoices)
        """
    ...
    def get_paginator(
        ...
        """
        [Paginator.ListLexicons documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Paginator.ListLexicons)
        """
    ...
    def get_paginator(
        ...
        """
        [Paginator.ListSpeechSynthesisTasks documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/polly.html#Polly.Paginator.ListSpeechSynthesisTasks)
        """
