...
class IntervalCronTrigger(BaseTrigger):
    ...
    def __init__(self,
                 months=0, weeks=0, days=0, skip_initial=False,
        ...
        self.start_date = self.timezone.normalize(start_date)
        self.end_date = self.timezone.normalize(end_date) if end_date else None
