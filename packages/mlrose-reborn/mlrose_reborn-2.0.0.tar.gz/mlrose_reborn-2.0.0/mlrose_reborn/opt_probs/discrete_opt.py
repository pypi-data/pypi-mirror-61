...
from mlrose_reborn.algorithms.crossovers import UniformCrossOver
from mlrose_reborn.algorithms.mutators import SwapMutator
from mlrose_reborn.opt_probs._opt_prob import _OptProb
...
class DiscreteOpt(_OptProb):
    ...
    # adapted from https://github.com/parkds/mlrose_reborn/blob/f7154a1d3e3fdcd934bb3c683b943264d2870fd1/mlrose_reborn/algorithms.py
