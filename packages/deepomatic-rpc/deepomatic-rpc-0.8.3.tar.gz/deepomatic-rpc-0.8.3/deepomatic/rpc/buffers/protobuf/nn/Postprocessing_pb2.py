...
StandardOutput = _reflection.GeneratedProtocolMessageType('StandardOutput', (_message.Message,), dict(
...
TextOutput = _reflection.GeneratedProtocolMessageType('TextOutput', (_message.Message,), dict(
