...
class Formula:
	...
	def save_symmetric_image(self, path): #, path):
		...
		shutil.copyfile(self.paths["sgv"], path)
		return {
...
def save_latex_image(expression, path, process_timeout = 2): #, path, density = 512, process_timeout = 2):
