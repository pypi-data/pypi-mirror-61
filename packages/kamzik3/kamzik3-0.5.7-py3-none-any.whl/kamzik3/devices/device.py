...
class Device(Subject, YamlSerializable):
    ...
    def _set(self, attribute_list, value, callback=None):
        ...
        if propagate_change:
            ...
            if value != current_value and self.device_server is not None:
                ...
                self.device_server.push_message(header, value, min_timeout=attribute_object.min_stream_timeout)
    ...
    def is_alive(self):
        ...
        if time_diff >= self.response_timeout * 1e-3:
            print(self.device_id, time_diff, self.request_timestamp, self.response_timestamp, self.response_timeout * 1e-3)
