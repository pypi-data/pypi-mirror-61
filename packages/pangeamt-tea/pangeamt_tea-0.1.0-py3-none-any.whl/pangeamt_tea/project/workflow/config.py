    ...
    def show(self):
        ...
        if data["clean"]:
            ...
            print(
                ...
                "(tea workflow clean -n <number of workers>)\n\n"
            )
            return
        ...
        if data["eval"]:
            print(
                f"Model evaluation started on {data['eval']['start']} and ended on "
                f"{data['eval']['end']}.\n"
            )
        else:
            print(
                "Evaluation is the next stage to run; "
                "(tea workflow evaluate <-gpu (optional)>)\n\n"
            )
            return
