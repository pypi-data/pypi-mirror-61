...
def _convert_linearmodels_result_to_statsmodels_result_format(
    result: PanelResults,
) -> None:
    """
    Note: inplace
    ...
    move_dict = {"std_errors": "bse", "tstats": "tvalues"}
    ...
    result.model.data = ModelData(param_names=[col for col in result.params.index],)
