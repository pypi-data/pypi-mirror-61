...
class connect_api_Query(connect_Base):
    ...
    _hx_statics = ["fromObject", "fromJson"]
    _hx_interfaces = []
    _hx_super = connect_Base
    ...
    def toObject(self):
        obj = python_lib_Json.loads(haxe_format_JsonPrinter.print(self,None,None),**python__KwArgs_KwArgs_Impl_.fromT(_hx_AnonObject({'object_hook': python_Lib.dictToAnon})))
        ...
        def _hx_local_1(key):
            startIndex = None
            index = (key.find("_") if ((startIndex is None)) else key.find("_", startIndex))
            fixedIndex = (index if ((index > -1)) else len(key))
            return HxString.substring(key,0,fixedIndex)
        renamedKeys = list(map(_hx_local_1,keys))
        out = _hx_AnonObject({})
        _g = 0
        _g1 = len(keys)
        while (_g < _g1):
            i = _g
            _g = (_g + 1)
            field1 = (renamedKeys[i] if i >= 0 and i < len(renamedKeys) else None)
    ...
    def fromObject(obj):
        ...
        if python_Boot.hasField(obj,"select"):
            rql.select_ = Reflect.field(obj,"select")
        if python_Boot.hasField(obj,"like"):
            value = Reflect.field(obj,"like")
            fields = python_Boot.fields(value)
            def _hx_local_0(field):
                _this = rql.like_
                value1 = Reflect.field(value,field)
                _this.h[field] = value1
                return
            Lambda.iter(fields,_hx_local_0)
        if python_Boot.hasField(obj,"ilike"):
            value2 = Reflect.field(obj,"ilike")
            fields1 = python_Boot.fields(value2)
            def _hx_local_1(field1):
                _this1 = rql.ilike_
                value3 = Reflect.field(value2,field1)
                _this1.h[field1] = value3
                return
            Lambda.iter(fields1,_hx_local_1)
        if python_Boot.hasField(obj,"in"):
            value4 = Reflect.field(obj,"in")
            fields2 = python_Boot.fields(value4)
            def _hx_local_2(field2):
                _this2 = rql.in__
                value5 = Reflect.field(value4,field2)
                _this2.h[field2] = value5
                return
            Lambda.iter(fields2,_hx_local_2)
        if python_Boot.hasField(obj,"out"):
            value6 = Reflect.field(obj,"out")
            fields3 = python_Boot.fields(value6)
            def _hx_local_3(field3):
                _this3 = rql.out_
                value7 = Reflect.field(value6,field3)
                _this3.h[field3] = value7
                return
            Lambda.iter(fields3,_hx_local_3)
        if python_Boot.hasField(obj,"relOps"):
            value8 = Reflect.field(obj,"relOps")
            fields4 = python_Boot.fields(value8)
            def _hx_local_5(field4):
                array = Reflect.field(value8,field4)
                _this4 = rql.relOps
                def _hx_local_4(kv):
                    return connect_api__Query_KeyValue(kv.key,kv.value)
                value9 = list(map(_hx_local_4,array))
                _this4.h[field4] = value9
            Lambda.iter(fields4,_hx_local_5)
        if python_Boot.hasField(obj,"ordering"):
            rql.ordering_ = Reflect.field(obj,"ordering")
        if python_Boot.hasField(obj,"limit"):
            rql.limit_ = Reflect.field(obj,"limit")
        if python_Boot.hasField(obj,"orderBy"):
            rql.orderBy_ = Reflect.field(obj,"orderBy")
        if python_Boot.hasField(obj,"offset"):
