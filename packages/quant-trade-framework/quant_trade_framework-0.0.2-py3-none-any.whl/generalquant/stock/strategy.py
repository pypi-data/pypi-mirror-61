...
from generalquant.stock.context import context
from generalquant.common.constant import Constant,Symbol
from datetime import timedelta
from generalquant.common.logConfig import Logger
from generalquant.model.Indicators import *
import math
from pytz import timezone
from generalquant.stock.account import account
import pandas as pd
import numpy as np
import pyecharts.options as opts
from pyecharts.charts import Line,Bar,Page
from pyecharts.components import Table
from generalquant.common.redisConfig import RuntimeConfig
from generalquant.common.admin import UserManager
    ...
    def indicator_cal(self):
        ...
        for name,account in context.accounts.items():
            ...
            for name1,position in account.position.items():
                temp_price = context.get_price(name1)
