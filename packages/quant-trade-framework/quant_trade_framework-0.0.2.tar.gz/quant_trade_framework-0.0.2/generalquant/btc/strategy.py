...
from generalquant.btc.context import context
...
from generalquant.btc.account import AccountBtc
import pandas as pd
import numpy as np
...
class strategy:
    ...
    def create_account(self,name:str,exchange:str,
        ...
        :return:
        """
        new_account = AccountBtc(name,exchange,account_type,position_base)
