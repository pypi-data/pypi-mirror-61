...
if platform.system() == "Windows":
    ...
    FILE_PATH_FOR_LIBS = "/Users/kerwin/MyBox/MyCode/Libs"
    FILE_PATH_FOR_ZIRU_CODE = "/Users/kerwin/MyBox/MyCode/BusinessProj/Ziru"
...
for path in site_pkgs_path:
    if os.path.exists(f"{path}/kw618"):
        ...
        break
FILE_PATH_FOR_KW618 = '/Users/kerwin/MyBox/kw618/kw618' # <toggle>
