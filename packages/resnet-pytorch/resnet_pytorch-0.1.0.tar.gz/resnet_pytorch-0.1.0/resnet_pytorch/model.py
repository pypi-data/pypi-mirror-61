...
class ResNet(nn.Module):
  ...
  def __init__(self, layers=None, global_params=None):
    ...
    zero_init_residual = global_params.zero_init_residual
    groups = global_params.groups
    width_per_group = global_params.width_per_group
    replace_stride_with_dilation = global_params.replace_stride_with_dilation
