...
python3 accuracy.py --api="genderguesser" --measure="precision" --csv=files/names/partialnoundefined.csv --jsondownloaded=files/names/partialnoundefined.csv.json > files/tests/accuracypartialprecisiongenderguesser-$(date "+%Y-%m-%d-%H").txt
