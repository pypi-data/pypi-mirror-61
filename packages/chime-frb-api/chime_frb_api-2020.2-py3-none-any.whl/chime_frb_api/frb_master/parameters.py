...
class Parameters(object):
    ...
    def get_max_size(self, datapath: str = None, fileformat: str = None) -> int:
        """
        Returns the maximum size of a file under a datapath (e.g. /frb-archiver) and matching a fileformat (e.g. *.h5)

        Parameters
        ----------
        datapath : str
            Absolute path to directory, e.g. /frb-archiver
        fileformat : str
            Format of the file to search, e.g. *.py, *.h5 or test.py
