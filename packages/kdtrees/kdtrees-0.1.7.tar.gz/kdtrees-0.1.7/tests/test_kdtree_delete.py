...
@pytest.mark.parametrize("points_1d_delete,delete_1d, delete_1d_exp", [
	([[4],[2],[5],[3],[7],[1],[9]], np.array([3]), "[4], axis: 0, nodes: 6\n" + \
							"\t[7], axis: 0, nodes: 3\n" + \
							"\t\t[9], axis: 0, nodes: 1\n" + \
							"\t\t\tNone\n" + "\t\t\tNone\n" + \
							"\t\t[5], axis: 0, nodes: 1\n" + \
	...
	([[1],[2],[3]], np.array([3]), "[2], axis: 0, nodes: 2\n" + \
					"\tNone\n" + \
					"\t[1], axis: 0, nodes: 1\n" + \
					"\t\tNone\n" + "\t\tNone\n"
					),
	([[1],[2]], np.array([1]), "[2], axis: 0, nodes: 1\n" + \
					"\tNone\n" + "\tNone\n"
					),
	([[1],[2]], np.array([2]), "[1], axis: 0, nodes: 1\n" + \
					"\tNone\n" + "\tNone\n"
					),
	([[1],[2]], np.array([3]), "[2], axis: 0, nodes: 2\n" + \
					"\tNone\n" + \
					"\t[1], axis: 0, nodes: 1\n" + \
					"\t\tNone\n" + "\t\tNone\n"
					),
	([[1],[2]], np.array([0]), "[2], axis: 0, nodes: 2\n" + \
					"\tNone\n" + \
					"\t[1], axis: 0, nodes: 1\n" + \
					"\t\tNone\n" + "\t\tNone\n"
					),
	([[1],[2],[3],[4]], np.array([4]), "[2], axis: 0, nodes: 3\n" + \
					"\t[3], axis: 0, nodes: 1\n" + \
					"\t\tNone\n" + "\t\tNone\n"
					"\t[1], axis: 0, nodes: 1\n" + \
					"\t\tNone\n" + "\t\tNone\n"
...
@pytest.mark.parametrize("points_2d_delete,delete_2d,delete_2d_exp", [
	([[0,0],[1,1],[1,0]], np.array([1,0]), "[1 1], axis: 0, nodes: 2\n" + \
									"\tNone\n" + \
									"\t[0 0], axis: 1, nodes: 1\n" + \
									"\t\tNone\n\t\tNone\n"
									),
	([[0,0],[1,1],[1,0]], np.array([2,0]), "[1 1], axis: 0, nodes: 3\n" + \
									"\t[1 0], axis: 1, nodes: 1\n" + \
									"\t\tNone\n\t\tNone\n" + \
									"\t[0 0], axis: 1, nodes: 1\n" + \
									"\t\tNone\n\t\tNone\n"
