...
# python setup.py build_sphinx
# updates documentation at http://packages.python.org/affo-event-service/
try:
...
with open("affo_event_service/__init__.py", "rb") as f:
...
setup(
    name="affo-event-service",
    version=version,
    description="",
    long_description=long_description,
    long_description_content_type="text/x-rst",
    url="https://github.com/affoio/affo-event-service",
