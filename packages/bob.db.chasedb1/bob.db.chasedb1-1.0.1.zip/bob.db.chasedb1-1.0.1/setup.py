...
setup(
    ...
    name='bob.db.chasedb1',
    version=open("version.txt").read().rstrip(),
    description='CHASE_DB1 Database Access API for Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.chasedb1',
    license='BSD',
    ...
    keywords = "retinal vessel segmentation, bob, bob.db, chasedb1",
    ...
    entry_points={
      ...
      'bob.db': [
        'chasedb1 = bob.db.chasedb1.driver:Interface',
      ],
      },
