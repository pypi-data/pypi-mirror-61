...
def create_keyvault(credential, tenant_id, subscription_id, resource_group_name, kv_name,location, sku, object_id):
    """ Create kv and give right to object id. It return kv url or '' """
    ...
    print(('New vault URI:'+vault.properties.vault_uri))
