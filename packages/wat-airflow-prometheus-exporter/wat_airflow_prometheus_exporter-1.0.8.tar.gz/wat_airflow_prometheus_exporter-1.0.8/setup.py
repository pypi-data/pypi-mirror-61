...
install_requirements = (["apache-airflow>=1.10.4", "prometheus_client>=0.4.2",],)
...
setup(
    ...
    name="wat_airflow_prometheus_exporter",
    packages=find_packages(include=["airflow_prometheus_exporter"]),
    include_package_data=True,
    url="https://github.com/fazzani/airflow_prometheus_exporter",
    version="1.0.8",
    entry_points={
        "airflow.plugins": [
