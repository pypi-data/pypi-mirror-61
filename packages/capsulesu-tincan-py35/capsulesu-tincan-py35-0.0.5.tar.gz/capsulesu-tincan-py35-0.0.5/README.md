...
This is a third-level fork needed for compatibilities in separate forks as of 2020-02-12.

For original project, check https://github.com/RusticiSoftware/TinCanPython. 

For Python 3.5+ compatibility and other changes, check https://github.com/edx/TinCanPython

For xAPI 1.0.3 compatibility, check https://github.com/mreimbold/TinCanPython

[![Build Status](https://travis-ci.org/leveque/TinCanPython.png)](https://travis-ci.org/leveque/TinCanPython)

For original hosted API documentation, basic usage instructions, supported version listing, etc. visit the main project website at:
...
## Installation
TinCanPython requires [Python 3.5](https://www.python.org/downloads/) or later.
