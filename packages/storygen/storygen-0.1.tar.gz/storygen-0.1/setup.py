...
setup(
  ...
  url = 'https://github.com/ahmaddoulat/storygen',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/ahmaddoulat/storygen/archive/v_01.tar.gz',    # I explain this later on
