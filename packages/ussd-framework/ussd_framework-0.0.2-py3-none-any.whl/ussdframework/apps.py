...
class UssdFrameWorkConfig(AppConfig):
    name = 'ussdframework'

    def ready(self):
        from ussdframework import screens
        ...
        from ussdframework.filters import date_filters
        from ussdframework.filters import dict_filters
        from ussdframework.filters import list_filters
        from ussdframework import built_in_functions
        from ussdframework.filters import utility_filters

        from ussdframework.core import env, _registered_filters, _built_in_functions
