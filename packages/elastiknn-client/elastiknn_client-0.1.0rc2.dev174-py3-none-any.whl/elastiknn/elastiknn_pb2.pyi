...
class ProcessorOptions(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"exact",u"jaccard",u"model_options"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"dimension",u"exact",u"field_raw",u"jaccard",u"model_options"]) -> None: ...
    else:
...
class ExactModelOptions(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"similarity"]) -> None: ...
    else:
...
class JaccardLshOptions(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        num_tables : typing___Optional[builtin___int] = None,
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"field_processed",u"num_bands",u"num_rows",u"num_tables",u"seed"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[u"field_processed",b"field_processed",u"num_bands",b"num_bands",u"num_rows",b"num_rows",u"num_tables",b"num_tables",u"seed",b"seed"]) -> None: ...
...
class SparseBoolVector(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"total_indices",u"true_indices"]) -> None: ...
    else:
...
class ElastiKnnVector(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"float_vector",u"sparse_bool_vector",u"vector"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"float_vector",u"sparse_bool_vector",u"vector"]) -> None: ...
    else:
...
class KNearestNeighborsQuery(google___protobuf___message___Message):
    ...
    class ExactQueryOptions(google___protobuf___message___Message):
        ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"field_raw",u"similarity"]) -> None: ...
        else:
    ...
    class IndexedQueryVector(google___protobuf___message___Message):
        ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"field",u"id",u"index"]) -> None: ...
        else:
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"exact",u"given",u"indexed",u"lsh",u"query_options",u"query_vector"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"exact",u"given",u"indexed",u"lsh",u"query_options",u"query_vector"]) -> None: ...
    else:
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"exact",b"exact",u"given",b"given",u"indexed",b"indexed",u"lsh",b"lsh",u"query_options",b"query_options",u"query_vector",b"query_vector"]) -> None: ...
    @typing___overload
