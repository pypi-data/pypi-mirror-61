...
from pyiArduinoI2Cdummy import *
import sys

# Объявляем объект module для работы с функциями и методами библиотеки pyiArduinoI2Cdummy.
...
module = pyiArduinoI2Cdummy(None, NO_BEGIN)
