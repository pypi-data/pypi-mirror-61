...
`sudo pip3 install pyiArduinoI2Cdummy`

Самостоятельная сборка из исходников:

`git clone https://github.com/tremaru/pyiArduinoI2Cdummy.git && cd pyiArduinoI2Cdummy/pyiArduinoI2Cdummy && python3 setup.py build_ext --inplace`

Примеры для Python находятся в папке `pyiArduinoI2Cdummy/examples`

Примеры для С++ находятся в папке `pyiArduinoI2Cdummy/cpp`. Так же в этой папке лежит *Makefile* для сборки
