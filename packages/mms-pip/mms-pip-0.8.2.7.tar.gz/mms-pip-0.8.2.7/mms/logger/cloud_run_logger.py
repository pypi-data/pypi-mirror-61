...
class CloudRunLogger(object):
    ...
    def info(self, message):
        self._do_log('INFO', message='MMS-INFO: ' + str(message))

    def warning(self, message):
        self._do_log('WARNING', message='MMS-WARNING: ' + str(message))

    def error(self, message):
        self._do_log('ERROR', message='MMS-ERROR: ' + str(message))

    def debug(self, message):
        self._do_log('DEBUG', message='MMS-DEBUG: ' + str(message))
