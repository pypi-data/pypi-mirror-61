...
class TurkishChecker(LanguageChecker):
    """
    The isValidWord method takes an input String as a word than define all valid characters as a validCharacters String
    which has letters (abcçdefgğhıijklmnoöprsştuüvyzABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVYZ),
