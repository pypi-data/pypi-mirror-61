# -*- coding: utf-8 -*-
from grpc_gen.systemSettingsService_pb2 import VersionMessage, GetLowestVersionResponse, GetVersionPageListResponse
...
class LowestVersion:
    ...
    def from_pb(cls, get_lowest_version_response: GetLowestVersionResponse):
        return cls(
            advise=Version.from_pb(get_lowest_version_response.advise),
            force=Version.from_pb(get_lowest_version_response.force)
        )
