...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-transfer", "1.23.0", __name__, "aws-transfer@1.23.0.jsii.tgz")
...
class CfnServer(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-transfer.CfnServer"):
    ...
    def attr_vpc_endpoint_id(self) -> str:
        """
        cloudformationAttribute:
        :cloudformationAttribute:: VpcEndpointId
        """
        return jsii.get(self, "attrVpcEndpointId")
