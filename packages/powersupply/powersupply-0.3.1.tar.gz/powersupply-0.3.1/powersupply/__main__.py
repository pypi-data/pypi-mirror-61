...
class DataPoller(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            if ucl:
                ps.usb_current_limit = 'usb' in supplies and ucl / 1000000.0
            if battery_temp:
            ...
            if os.path.isdir('/sys/class/typec/port0'):
                ...
                ps.typec_pr = self.read_sysfs_enum('/sys/class/typec/port0/power_role')
                ps.typec_dr = self.read_sysfs_enum('/sys/class/typec/port0/data_role')
                ps.typec_operation_mode = self.read_sysfs_str('/sys/class/typec/port0/power_operation_mode')
