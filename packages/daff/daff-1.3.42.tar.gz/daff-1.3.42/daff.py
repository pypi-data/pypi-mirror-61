...
class Alignment(object):
    ...
    def toString(self):
        result = (((u"" + HxOverrides.stringOrNull(self.map_a2b.toString())) + u" // ") + HxOverrides.stringOrNull(self.map_b2a.toString()))
    ...
    def toOrder3(self):
        ...
        if (self.reference is None):
            ...
            k4 = self.map_a2b.keys()
            while k4.hasNext():
                k5 = hxnext(k4)
                unit2 = Unit()
                unit2.p = k5
                unit2.l = self.reference.a2b(k5)
                unit2.r = self.a2b(k5)
                order.append(unit2)
            k6 = self.reference.map_b2a.keys()
            while k6.hasNext():
                k7 = hxnext(k6)
                if (self.reference.b2a(k7) == -1):
                    unit3 = Unit()
                    unit3.p = -1
                    unit3.l = k7
                    unit3.r = -1
                    order.append(unit3)
            k8 = self.map_b2a.keys()
            while k8.hasNext():
                k9 = hxnext(k8)
                if (self.b2a(k9) == -1):
                    unit4 = Unit()
        ...
        if (self.reference is not None):
            def _hx_local_2(a2,b2):
                ...
                if (((order[a2] if a2 >= 0 and a2 < len(order) else None).p >= 0) and (((order[b2] if b2 >= 0 and b2 < len(order) else None).p >= 0))):
                    o2 = ((order[a2] if a2 >= 0 and a2 < len(order) else None).p - (order[b2] if b2 >= 0 and b2 < len(order) else None).p)
                    if ((o1 * o2) < 0):
                        return o1
                    o3 = ((order[a2] if a2 >= 0 and a2 < len(order) else None).l - (order[b2] if b2 >= 0 and b2 < len(order) else None).l)
                    return o3
                return o1
            ...
            def _hx_local_3(a3,b3):
                ...
                if (((order[a3] if a3 >= 0 and a3 < len(order) else None).l >= 0) and (((order[b3] if b3 >= 0 and b3 < len(order) else None).l >= 0))):
                    ...
                    if (((order[a3] if a3 >= 0 and a3 < len(order) else None).p >= 0) and (((order[b3] if b3 >= 0 and b3 < len(order) else None).p >= 0))):
                        o21 = ((order[a3] if a3 >= 0 and a3 < len(order) else None).p - (order[b3] if b3 >= 0 and b3 < len(order) else None).p)
                        if ((o11 * o21) < 0):
                            return o11
                        return o21
...
class CompareTable(object):
    ...
    def alignCore2(self,align,a,b):
        ...
        if (ids is not None):
            ...
            if (len(common_units) > N):
                ...
                _g6 = []
                x = python_HaxeIterator(columns_eval.__iter__())
                while x.hasNext():
                    x1 = hxnext(x)
            ...
            while (_g42 < _g52):
                ...
                while j4.hasNext():
                    ...
                    if (not (val in used.h)):
                        ...
                        align.link(j5,val)
                        used.set(val,1)
                        if (not (j5 in used_reverse.h)):
                            reverse_pending_ct = (reverse_pending_ct - 1)
                        used_reverse.set(j5,1)
                _g61 = 0
                _g7 = len(fixed)
                while (_g61 < _g7):
                    j6 = _g61
                    _g61 = (_g61 + 1)
                    pending.remove((fixed[j6] if j6 >= 0 and j6 < len(fixed) else None))
    ...
    def alignColumns(self,align,a,b):
        ...
        while key4.hasNext():
            key5 = hxnext(key4)
            i01 = ma_best.h.get(key5,None)
            i11 = mb_best.h.get(key5,None)
        ...
        while key6.hasNext():
            key7 = hxnext(key6)
            i02 = ma_best.h.get(key7,None)
            i12 = mb_best.h.get(key7,None)
...
class Coopy(object):
        ...
        if (len(order) > 1):
            ...
            while (_g < _g1):
                ...
                if (t is not None):
                    ...
                    line = u""
                    _g2 = 0
                    _g11 = len((order[i] if i >= 0 and i < len(order) else None))
                    while (_g2 < _g11):
                        i1 = _g2
                        _g2 = (_g2 + 1)
    ...
    def command(self,io,cmd,args):
        ...
        if (r != 999):
            ...
            while (_g < len(args)):
                ...
                io.writeStdout(u" ")
                startIndex = None
                spaced = (((arg.find(u" ") if ((startIndex is None)) else arg.find(u" ", startIndex))) >= 0)
                if spaced:
                    io.writeStdout(u"\"")
                io.writeStdout(arg)
                if spaced:
    ...
    def installGitDriver(self,io,formats):
        ...
        while (_g2 < len(formats)):
            ...
            _g2 = (_g2 + 1)
            key = (u"have_diff_driver_" + (u"null" if format1 is None else format1))
            if (not (key in self.status.h)):
                r = self.command(io,u"git",[u"config", u"--global", u"--get", ((u"diff.daff-" + (u"null" if format1 is None else format1)) + u".command")])
                if (r == 999):
                    return r
                self.status.h[key] = r
            have_diff_driver = (self.status.h.get(key,None) == 0)
            key = (u"add_diff_driver_" + (u"null" if format1 is None else format1))
            if (not (key in self.status.h)):
                r = self.command(io,u"git",[u"config", u"--global", ((u"diff.daff-" + (u"null" if format1 is None else format1)) + u".command"), (HxOverrides.stringOrNull(self.daff_cmd) + u" diff --git")])
                if (r == 999):
                    return r
                if have_diff_driver:
                    io.writeStdout(((u"- Cleared existing daff diff driver for " + (u"null" if format1 is None else format1)) + u"\n"))
                io.writeStdout(((u"- Added diff driver for " + (u"null" if format1 is None else format1)) + u"\n"))
                self.status.h[key] = r
            key = (u"have_merge_driver_" + (u"null" if format1 is None else format1))
            if (not (key in self.status.h)):
                r = self.command(io,u"git",[u"config", u"--global", u"--get", ((u"merge.daff-" + (u"null" if format1 is None else format1)) + u".driver")])
                if (r == 999):
                    return r
                self.status.h[key] = r
            have_merge_driver = (self.status.h.get(key,None) == 0)
            key = (u"name_merge_driver_" + (u"null" if format1 is None else format1))
            if (not (key in self.status.h)):
                if (not have_merge_driver):
                    r = self.command(io,u"git",[u"config", u"--global", ((u"merge.daff-" + (u"null" if format1 is None else format1)) + u".name"), ((u"daff tabular " + (u"null" if format1 is None else format1)) + u" merge")])
                    if (r == 999):
                        return r
                else:
                    r = 0
                self.status.h[key] = r
            key = (u"add_merge_driver_" + (u"null" if format1 is None else format1))
            if (not (key in self.status.h)):
                r = self.command(io,u"git",[u"config", u"--global", ((u"merge.daff-" + (u"null" if format1 is None else format1)) + u".driver"), (HxOverrides.stringOrNull(self.daff_cmd) + u" merge --output %A %O %A %B")])
                if (r == 999):
                    return r
                if have_merge_driver:
                    io.writeStdout(((u"- Cleared existing daff merge driver for " + (u"null" if format1 is None else format1)) + u"\n"))
                io.writeStdout(((u"- Added merge driver for " + (u"null" if format1 is None else format1)) + u"\n"))
                self.status.h[key] = r
        ...
        need_update = False
        _g11 = 0
        while (_g11 < len(formats)):
            format2 = (formats[_g11] if _g11 >= 0 and _g11 < len(formats) else None)
            _g11 = (_g11 + 1)
            _hx_str = (u"*." + (u"null" if format2 is None else format2))
            startIndex = None
            if (((txt.find(_hx_str) if ((startIndex is None)) else txt.find(_hx_str, startIndex))) >= 0):
                io.writeStderr(((u"- Your .gitattributes file already mentions *." + (u"null" if format2 is None else format2)) + u"\n"))
            else:
                post = ((u"null" if post is None else post) + HxOverrides.stringOrNull((((((u"*." + (u"null" if format2 is None else format2)) + u" diff=daff-") + (u"null" if format2 is None else format2)) + u"\n"))))
                post = ((u"null" if post is None else post) + HxOverrides.stringOrNull((((((u"*." + (u"null" if format2 is None else format2)) + u" merge=daff-") + (u"null" if format2 is None else format2)) + u"\n"))))
    ...
    def run(self,args,io = None):
        ...
        try:
            ...
            if (not Lambda.has([u"diff", u"patch", u"merge", u"trim", u"render", u"git", u"version", u"copy"],cmd1)):
                startIndex = None
                if (((cmd1.find(u"--") if ((startIndex is None)) else cmd1.find(u"--", startIndex))) == 0):
                    cmd1 = u"diff"
                    offset = 0
                else:
                    startIndex1 = None
                    if (((cmd1.find(u".") if ((startIndex1 is None)) else cmd1.find(u".", startIndex1))) != -1):
                        if (len(args) == 2):
                            cmd1 = u"diff"
                            offset = 0
                        elif (len(args) == 1):
            ...
            if (cmd1 == u"git"):
                ...
                if (pos30 < 0):
                    pos30 = 0
                res30 = args[pos30:(pos30 + _hx_len)]
                del args[pos30:(pos30 + _hx_len)]
                types = res30
...
class Csv(object):
    ...
    def renderCell(self,v,d,force_quote = None):
                ...
                if (ch == ((u"" if ((0 >= len(_this))) else _this[0]))):
                    ...
                    if ((i + len(self.delim)) <= len(_hx_str)):
                        ...
                        while (_g2 < _g11):
                            ...
                            _g2 = (_g2 + 1)
                            index1 = (i + j)
                            tmp1 = (u"" if (((index1 < 0) or ((index1 >= len(_hx_str))))) else _hx_str[index1])
                            _this1 = self.delim
                            if (tmp1 != ((u"" if (((j < 0) or ((j >= len(_this1))))) else _this1[j]))):
                                match = False
                                break
                        if match:
                            need_quote = True
        ...
        while (_g3 < _g12):
            i1 = _g3
            _g3 = (_g3 + 1)
            ch1 = (u"" if (((i1 < 0) or ((i1 >= len(_hx_str))))) else _hx_str[i1])
            if (ch1 == u"\""):
                result = ((u"null" if result is None else result) + u"\"")
            if ((ch1 != u"\r") and ((ch1 != u"\n"))):
                if (len(line_buf) > 0):
                    ...
                    line_buf = u""
                result = ((u"null" if result is None else result) + (u"null" if ch1 is None else ch1))
            else:
                line_buf = ((u"null" if line_buf is None else line_buf) + (u"null" if ch1 is None else ch1))
        if (len(line_buf) > 0):
            result = ((u"null" if result is None else result) + (u"null" if line_buf is None else line_buf))
        if need_quote:
            result = ((u"null" if result is None else result) + u"\"")
...
class DiffRender(object):
    ...
    def examineCell(x,y,view,raw,vcol,vrow,vcorner,cell,offset = None):
        ...
        startIndex = None
        if (((vcol.find(u"+++") if ((startIndex is None)) else vcol.find(u"+++", startIndex))) >= 0):
            def _hx_local_3():
                cell.category = u"add"
            ...
            startIndex1 = None
            if (((vcol.find(u"---") if ((startIndex1 is None)) else vcol.find(u"---", startIndex1))) >= 0):
                def _hx_local_4():
        ...
        if (vrow == u"!"):
            ...
            startIndex2 = None
            if (((vrow.find(u"->") if ((startIndex2 is None)) else vrow.find(u"->", startIndex2))) >= 0):
                if (not removed_column):
                    tokens = vrow.split(u"!")
                    full = vrow
                    ...
                    if (not nested):
                        startIndex3 = None
                        tmp = (((_hx_str.find(part) if ((startIndex3 is None)) else _hx_str.find(part, startIndex3))) >= 0)
                    else:
                        tmp = True
                    if tmp:
                        cat = u"modify"
                        ...
                        if (part != full):
                            if nested:
                                ...
                                startIndex4 = None
                                cell.conflicted = (((_hx_str.find(full) if ((startIndex4 is None)) else _hx_str.find(full, startIndex4))) >= 0)
                            if cell.conflicted:
                                div = full
                                cat = u"conflict"
                        cell.updated = True
...
class HighlightPatch(object):
    ...
    def applyRow(self,r):
        ...
        if ((r == 0) and ((self.rcOffset > 0))):
            ...
            startIndex = None
            if (((code.find(u"@") if ((startIndex is None)) else code.find(u"@", startIndex))) == 0):
        ...
        if (not done):
            ...
            if (code == u"+++"):
                ...
                startIndex1 = None
                if (((code.find(u"->") if ((startIndex1 is None)) else code.find(u"->", startIndex1))) >= 0):
                    self.applyAction(u"->")
                else:
                    self.lastSourceRow = -1
    ...
    def processMods(self,rmods,fate,_hx_len):
        ...
        while (_g < len(rmods)):
            ...
            if (last != -1):
                _g1 = last
                _g11 = (mod.sourceRow + mod.sourceRowOffset)
                while (_g1 < _g11):
                    i = _g1
                    _g1 = (_g1 + 1)
        ...
        while (_g < len(_g1)):
            ...
            if (not cmod.rem):
                if cmod.add:
                    ...
                    _g11 = self.mods
                    while (_g2 < len(_g11)):
                        mod = (_g11[_g2] if _g2 >= 0 and _g2 < len(_g11) else None)
                        _g2 = (_g2 + 1)
                ...
                if mod1.add:
                    ...
                    while c.hasNext():
                        ...
                        if ((offset is not None) and ((offset >= 0))):
                            self.source.setCell(offset,mod1.destRow,self.patch.getCell(c1,mod1.patchRow))
                elif mod1.update:
                    ...
                    while c2.hasNext():
                        c3 = hxnext(c2)
                        txt = self.view.toString(self.patch.getCell(c3,mod1.patchRow))
                        DiffRender.examineCell(0,0,self.view,txt,u"",self.rowInfo.value,u"",self.cellInfo)
                        if (not self.cellInfo.updated):
                            continue
                        ...
                        if ((offset1 is not None) and ((offset1 >= 0))):
                            self.source.setCell(self.patchInDestCol.h.get(c3,None),mod1.destRow,d)
    ...
    def finishColumns(self):
        ...
        if (self.headerMove is not None):
            if (len(self.colPermutation) > 0):
                ...
                _g5 = self.cmods
                while (_g4 < len(_g5)):
                    mod3 = (_g5[_g4] if _g4 >= 0 and _g4 < len(_g5) else None)
                    _g4 = (_g4 + 1)
                    if (mod3.sourceRow >= 0):
        ...
        _g51 = self.cmods
        while (_g41 < len(_g51)):
            mod4 = (_g51[_g41] if _g41 >= 0 and _g41 < len(_g51) else None)
            _g41 = (_g41 + 1)
            if (mod4.code != u""):
                changed = True
                break
    ...
    def apply(self):
        ...
        while (_g < len(_g1)):
            ...
            if (((row.l >= 0) and ((row.r >= 0))) and ((row.p >= 0))):
                _g2 = 0
                _g11 = self.column_units
                while (_g2 < len(_g11)):
                    col = (_g11[_g2] if _g2 >= 0 and _g2 < len(_g11) else None)
                    _g2 = (_g2 + 1)
        ...
        while x.hasNext():
            ...
            _g3 = self.units
            while (_g21 < len(_g3)):
                unit = (_g3[_g21] if _g21 >= 0 and _g21 < len(_g3) else None)
                _g21 = (_g21 + 1)
        ...
        while y.hasNext():
            ...
            _g22 = 0
            _g31 = self.column_units
            while (_g22 < len(_g31)):
                unit1 = (_g31[_g22] if _g22 >= 0 and _g22 < len(_g31) else None)
                _g22 = (_g22 + 1)
                if ((unit1.l >= 0) and ((unit1.r >= 0))):
                    self.local.setCell(self.column_mix_local.h.get(unit1.l,None),y2,self.remote.getCell(unit1.r,y1))
...
class Ndjson(object):
    ...
    def addRow(self,r,txt):
        ...
        if resize:
            self.tab.resize(w,h)
        _g2 = 0
        _g3 = python_Boot.fields(json)
        while (_g2 < len(_g3)):
            name1 = (_g3[_g2] if _g2 >= 0 and _g2 < len(_g3) else None)
            _g2 = (_g2 + 1)
...
class SimpleMeta(object):
    ...
    def alterColumns(self,columns):
        ...
        while (_g6 < _g7):
            ...
            if (col2.name is not None):
                ...
                _g71 = col2.props
                while (_g61 < len(_g71)):
                    prop = (_g71[_g61] if _g61 >= 0 and _g61 < len(_g71) else None)
                    _g61 = (_g61 + 1)
    ...
    def cloneMeta(self,table = None):
        ...
        if (self.metadata is not None):
            ...
            k2 = self.metadata.keys()
            while k2.hasNext():
                k3 = hxnext(k2)
                if (not (k3 in self.metadata.h)):
                    continue
                vals = self.metadata.h.get(k3,None)
    ...
    def tableToString(tab):
            ...
            if (stream is not None):
                ...
                while (row is not None):
                    ...
                    while (_g2 < _g3):
                        ...
                        if (i1 > 0):
                            x = ((u"null" if x is None else x) + u",")
                        x = ((u"null" if x is None else x) + Std.string(row.h.get((cols[i1] if i1 >= 0 and i1 < len(cols) else None),None)))
                    x = ((u"null" if x is None else x) + u"\n")
                    row = stream.fetchRow()
                return x
        x1 = u""
        ...
        while (_g4 < _g11):
            ...
            while (_g5 < _g12):
                ...
                _g5 = (_g5 + 1)
                if (j > 0):
                    x1 = ((u"null" if x1 is None else x1) + u",")
                x1 = ((u"null" if x1 is None else x1) + Std.string(tab.getCell(j,i2)))
            x1 = ((u"null" if x1 is None else x1) + u"\n")
        return x1
...
class SqlCompare(object):
    ...
    def validateSchema(self):
        ...
        if (self.alt is not None):
            ...
            if (len(key_cols3) == 0):
                pk_missing = True
        if access_error:
            raise _HxException(u"Error accessing SQL table")
        if pk_missing:
            raise _HxException(u"sql diff not possible when primary key not available")
        pk_change = False
        ...
        if ((self.local is not None) and ((self.alt is not None))):
            if (not self.equalArray(key_cols1,key_cols3)):
                pk_change = True
        if pk_change:
            raise _HxException((u"sql diff not possible when primary key changes: " + Std.string([key_cols1, key_cols2, key_cols3])))
        return True
    ...
    def scanColumns(self,all_cols1,all_cols2,key_cols,present1,present2,align):
        ...
        while (_g2 < _g3):
            i1 = _g2
            _g2 = (_g2 + 1)
            key1 = (all_cols2[i1] if i1 >= 0 and i1 < len(all_cols2) else None)
            if (not (key1 in present1.h)):
                align.meta.link(-1,i1)
        align.meta.range(len(all_cols1),len(all_cols2))
        _g4 = 0
        while (_g4 < len(key_cols)):
            key2 = (key_cols[_g4] if _g4 >= 0 and _g4 < len(key_cols) else None)
            _g4 = (_g4 + 1)
    ...
    def apply(self):
        ...
        if (self.local is not None):
            ...
            if (self.flags.ids is not None):
                ...
                while (_g < len(key_cols)):
                    ...
                    pks.h[col] = True
                _g1 = 0
                while (_g1 < len(all_cols)):
                    col1 = (all_cols[_g1] if _g1 >= 0 and _g1 < len(all_cols) else None)
                    _g1 = (_g1 + 1)
        ...
        while (_g21 < _g3):
            i1 = _g21
            _g21 = (_g21 + 1)
            key = (all_cols1[i1] if i1 >= 0 and i1 < len(all_cols1) else None)
            present1.h[key] = i1
        _g4 = 0
        _g5 = len(all_cols2)
        while (_g4 < _g5):
            i2 = _g4
            _g4 = (_g4 + 1)
            key1 = (all_cols2[i2] if i2 >= 0 and i2 < len(all_cols2) else None)
            if (not (key1 in present1.h)):
                has_column_add = True
            present2.h[key1] = i2
        _g6 = 0
        ...
        while (_g6 < _g7):
            i3 = _g6
            _g6 = (_g6 + 1)
            key2 = (all_cols3[i3] if i3 >= 0 and i3 < len(all_cols3) else None)
        ...
        while (_g8 < _g9):
            i4 = _g8
            _g8 = (_g8 + 1)
            key3 = (all_cols1[i4] if i4 >= 0 and i4 < len(all_cols1) else None)
        ...
        while (_g10 < _g111):
            i5 = _g10
            _g10 = (_g10 + 1)
            key4 = (all_cols2[i5] if i5 >= 0 and i5 < len(all_cols2) else None)
        ...
        while (_g12 < _g13):
            ...
            sql_key_cols = ((u"null" if sql_key_cols is None else sql_key_cols) + HxOverrides.stringOrNull(common.getQuotedColumnName((key_cols[i6] if i6 >= 0 and i6 < len(key_cols) else None))))
        sql_all_cols = u""
        _g14 = 0
        _g15 = len(all_common_cols)
        while (_g14 < _g15):
            i7 = _g14
            _g14 = (_g14 + 1)
            if (i7 > 0):
                sql_all_cols = ((u"null" if sql_all_cols is None else sql_all_cols) + u",")
            sql_all_cols = ((u"null" if sql_all_cols is None else sql_all_cols) + HxOverrides.stringOrNull(common.getQuotedColumnName((all_common_cols[i7] if i7 >= 0 and i7 < len(all_common_cols) else None))))
        sql_all_cols1 = u""
        _g16 = 0
        _g17 = len(all_cols1)
        while (_g16 < _g17):
            ...
            sql_all_cols1 = ((u"null" if sql_all_cols1 is None else sql_all_cols1) + HxOverrides.stringOrNull(((((u"null" if sql_table1 is None else sql_table1) + u".") + HxOverrides.stringOrNull(self.local.getQuotedColumnName((all_cols1[i8] if i8 >= 0 and i8 < len(all_cols1) else None)))))))
        sql_all_cols2 = u""
        _g18 = 0
        _g19 = len(all_cols2)
        while (_g18 < _g19):
            ...
            sql_all_cols2 = ((u"null" if sql_all_cols2 is None else sql_all_cols2) + HxOverrides.stringOrNull(((((u"null" if sql_table2 is None else sql_table2) + u".") + HxOverrides.stringOrNull(self.remote.getQuotedColumnName((all_cols2[i9] if i9 >= 0 and i9 < len(all_cols2) else None)))))))
        sql_all_cols3 = u""
        if (self.alt is not None):
            _g20 = 0
            _g211 = len(all_cols3)
            while (_g20 < _g211):
                ...
                sql_all_cols3 = ((u"null" if sql_all_cols3 is None else sql_all_cols3) + HxOverrides.stringOrNull(((((u"null" if sql_table3 is None else sql_table3) + u".") + HxOverrides.stringOrNull(self.alt.getQuotedColumnName((all_cols3[i10] if i10 >= 0 and i10 < len(all_cols3) else None)))))))
        sql_key_null = u""
        _g201 = 0
        _g212 = len(key_cols)
        while (_g201 < _g212):
        ...
        while (_g22 < _g23):
            ...
            sql_key_null2 = ((u"null" if sql_key_null2 is None else sql_key_null2) + HxOverrides.stringOrNull((((((u"null" if sql_table2 is None else sql_table2) + u".") + (u"null" if n1 is None else n1)) + u" IS NULL"))))
        sql_key_match2 = u""
        _g24 = 0
        _g25 = len(key_cols)
        while (_g24 < _g25):
            ...
            n2 = common.getQuotedColumnName((key_cols[i13] if i13 >= 0 and i13 < len(key_cols) else None))
            sql_key_match2 = ((u"null" if sql_key_match2 is None else sql_key_match2) + HxOverrides.stringOrNull(((((((((u"null" if sql_table1 is None else sql_table1) + u".") + (u"null" if n2 is None else n2)) + u" IS ") + (u"null" if sql_table2 is None else sql_table2)) + u".") + (u"null" if n2 is None else n2)))))
        sql_key_match3 = u""
        if (self.alt is not None):
            _g26 = 0
            _g27 = len(key_cols)
            while (_g26 < _g27):
                ...
                n3 = common.getQuotedColumnName((key_cols[i14] if i14 >= 0 and i14 < len(key_cols) else None))
                sql_key_match3 = ((u"null" if sql_key_match3 is None else sql_key_match3) + HxOverrides.stringOrNull(((((((((u"null" if sql_table1 is None else sql_table1) + u".") + (u"null" if n3 is None else n3)) + u" IS ") + (u"null" if sql_table3 is None else sql_table3)) + u".") + (u"null" if n3 is None else n3)))))
        sql_data_mismatch = u""
        _g261 = 0
        _g271 = len(data_common_cols)
        while (_g261 < _g271):
            i15 = _g261
            _g261 = (_g261 + 1)
            if (i15 > 0):
                sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + u" OR ")
            n4 = common.getQuotedColumnName((data_common_cols[i15] if i15 >= 0 and i15 < len(data_common_cols) else None))
            sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + HxOverrides.stringOrNull(((((((((u"null" if sql_table1 is None else sql_table1) + u".") + (u"null" if n4 is None else n4)) + u" IS NOT ") + (u"null" if sql_table2 is None else sql_table2)) + u".") + (u"null" if n4 is None else n4)))))
        _g28 = 0
        _g29 = len(all_cols2)
        while (_g28 < _g29):
            i16 = _g28
            _g28 = (_g28 + 1)
            key5 = (all_cols2[i16] if i16 >= 0 and i16 < len(all_cols2) else None)
            if (not (key5 in present1.h)):
                if (sql_data_mismatch != u""):
                    sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + u" OR ")
                n5 = common.getQuotedColumnName(key5)
                sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + HxOverrides.stringOrNull((((((u"null" if sql_table2 is None else sql_table2) + u".") + (u"null" if n5 is None else n5)) + u" IS NOT NULL"))))
        if (self.alt is not None):
            _g30 = 0
            _g31 = len(data_common_cols)
            while (_g30 < _g31):
                i17 = _g30
                _g30 = (_g30 + 1)
                if (len(sql_data_mismatch) > 0):
                    sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + u" OR ")
                n6 = common.getQuotedColumnName((data_common_cols[i17] if i17 >= 0 and i17 < len(data_common_cols) else None))
                sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + HxOverrides.stringOrNull(((((((((u"null" if sql_table1 is None else sql_table1) + u".") + (u"null" if n6 is None else n6)) + u" IS NOT ") + (u"null" if sql_table3 is None else sql_table3)) + u".") + (u"null" if n6 is None else n6)))))
            _g32 = 0
            _g33 = len(all_cols3)
            while (_g32 < _g33):
                i18 = _g32
                _g32 = (_g32 + 1)
                key6 = (all_cols3[i18] if i18 >= 0 and i18 < len(all_cols3) else None)
                if (not (key6 in present1.h)):
                    if (sql_data_mismatch != u""):
                        sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + u" OR ")
                    n7 = common.getQuotedColumnName(key6)
                    sql_data_mismatch = ((u"null" if sql_data_mismatch is None else sql_data_mismatch) + HxOverrides.stringOrNull((((((u"null" if sql_table3 is None else sql_table3) + u".") + (u"null" if n7 is None else n7)) + u" IS NOT NULL"))))
        sql_dbl_cols = u""
        dbl_cols = []
        _g301 = 0
        _g311 = len(all_cols1)
        while (_g301 < _g311):
            ...
            buf = (u"__coopy_" + Std.string(i19))
            n8 = common.getQuotedColumnName((all_cols1[i19] if i19 >= 0 and i19 < len(all_cols1) else None))
            sql_dbl_cols = ((u"null" if sql_dbl_cols is None else sql_dbl_cols) + HxOverrides.stringOrNull(((((((u"null" if sql_table1 is None else sql_table1) + u".") + (u"null" if n8 is None else n8)) + u" AS ") + (u"null" if buf is None else buf)))))
            dbl_cols.append(buf)
        _g321 = 0
        _g331 = len(all_cols2)
        while (_g321 < _g331):
            ...
            if (sql_dbl_cols != u""):
                sql_dbl_cols = ((u"null" if sql_dbl_cols is None else sql_dbl_cols) + u",")
            buf1 = ((u"__coopy_" + Std.string(i20)) + u"b")
            n9 = common.getQuotedColumnName((all_cols2[i20] if i20 >= 0 and i20 < len(all_cols2) else None))
            sql_dbl_cols = ((u"null" if sql_dbl_cols is None else sql_dbl_cols) + HxOverrides.stringOrNull(((((((u"null" if sql_table2 is None else sql_table2) + u".") + (u"null" if n9 is None else n9)) + u" AS ") + (u"null" if buf1 is None else buf1)))))
        ...
        if (self.alt is not None):
            ...
            while (_g34 < _g35):
                ...
                if (sql_dbl_cols != u""):
                    sql_dbl_cols = ((u"null" if sql_dbl_cols is None else sql_dbl_cols) + u",")
                buf2 = ((u"__coopy_" + Std.string(i21)) + u"c")
                n10 = common.getQuotedColumnName((all_cols3[i21] if i21 >= 0 and i21 < len(all_cols3) else None))
                sql_dbl_cols = ((u"null" if sql_dbl_cols is None else sql_dbl_cols) + HxOverrides.stringOrNull(((((((u"null" if sql_table3 is None else sql_table3) + u".") + (u"null" if n10 is None else n10)) + u" AS ") + (u"null" if buf2 is None else buf2)))))
        ...
        while (_g341 < _g351):
            ...
            n11 = common.getQuotedColumnName((key_cols[i22] if i22 >= 0 and i22 < len(key_cols) else None))
            sql_order = ((u"null" if sql_order is None else sql_order) + (u"null" if n11 is None else n11))
        rowid = u"-3"
        rowid1 = u"-3"
        rowid2 = u"-3"
        rowid3 = u"-3"
        ...
        if (self.alt is not None):
            sql_inserts1 = (((((u"SELECT DISTINCT 0 AS __coopy_code, NULL, NULL, " + (u"null" if rowid3 is None else rowid3)) + u" AS rowid, ") + (u"null" if sql_all_cols3 is None else sql_all_cols3)) + u" FROM ") + (u"null" if sql_table3 is None else sql_table3))
            if (self.local is not None):
                sql_inserts1 = ((u"null" if sql_inserts1 is None else sql_inserts1) + HxOverrides.stringOrNull(((u" LEFT JOIN " + (u"null" if sql_table1 is None else sql_table1)))))
                sql_inserts1 = ((u"null" if sql_inserts1 is None else sql_inserts1) + HxOverrides.stringOrNull((((u" ON " + (u"null" if sql_key_match3 is None else sql_key_match3)) + HxOverrides.stringOrNull(self.where(sql_key_null))))))
            if (sql_table1 != sql_table3):
                sql_inserts_order1 = ([u"__coopy_code", u"NULL", u"NULL", u"rowid"] + all_cols3)
        ...
        if (self.alt is not None):
            sql_deletes1 = ((((u"SELECT 2 AS __coopy_code, " + (u"null" if rowid1 is None else rowid1)) + u" AS __coopy_rowid0, ") + (u"null" if rowid2 is None else rowid2)) + u" AS __coopy_rowid1, ")
            sql_deletes1 = ((u"null" if sql_deletes1 is None else sql_deletes1) + HxOverrides.stringOrNull((((u"null" if rowid3 is None else rowid3) + u" AS __coopy_rowid2, "))))
            sql_deletes1 = ((u"null" if sql_deletes1 is None else sql_deletes1) + (u"null" if sql_dbl_cols is None else sql_dbl_cols))
            sql_deletes1 = ((u"null" if sql_deletes1 is None else sql_deletes1) + HxOverrides.stringOrNull(((u" FROM " + (u"null" if sql_table1 is None else sql_table1)))))
            if (self.remote is not None):
                sql_deletes1 = ((u"null" if sql_deletes1 is None else sql_deletes1) + HxOverrides.stringOrNull(((((u" LEFT OUTER JOIN " + (u"null" if sql_table2 is None else sql_table2)) + u" ON ") + (u"null" if sql_key_match2 is None else sql_key_match2)))))
            sql_deletes1 = ((u"null" if sql_deletes1 is None else sql_deletes1) + HxOverrides.stringOrNull(((((u" LEFT OUTER JOIN " + (u"null" if sql_table3 is None else sql_table3)) + u" ON ") + (u"null" if sql_key_match3 is None else sql_key_match3)))))
            sql_deletes1 = ((u"null" if sql_deletes1 is None else sql_deletes1) + u" WHERE __coopy_rowid1 IS NULL OR __coopy_rowid2 IS NULL")
            sql_deletes_order1 = ([u"__coopy_code", u"__coopy_rowid0", u"__coopy_rowid1", u"__coopy_rowid2"] + dbl_cols)
...
class SqliteHelper(object):
    ...
    def update(self,db,name,conds,vals):
        ...
        while k2.hasNext():
            ...
            q = ((u"null" if q is None else q) + HxOverrides.stringOrNull(db.getQuotedColumnName(k3)))
            q = ((u"null" if q is None else q) + u" IS ?")
            x1 = conds.h.get(k3,None)
            lst.append(x1)
        ...
        while (_g < _g1):
            ...
            if (c.name is not None):
                if (c.prevName is not None):
                    x1 = c.prevName
                    sel_column_list.append(x1)
                    x2 = c.name
                    ins_column_list.append(x2)
                orig_type = u""
                orig_primary = False
...
class Std(object):
    ...
    __slots__ = ()
    _hx_statics = [u"is", u"string", u"parseInt"]
...
class TableDiff(object):
    ...
    def getSeparator(self,t,t2,root):
        ...
        while (_g < _g1):
            ...
            while (_g2 < _g11):
                ...
                while True:
                    startIndex = None
                    if (not ((((txt.find(sep) if ((startIndex is None)) else txt.find(sep, startIndex))) >= 0))):
                        break
        ...
        if (t2 is not None):
            ...
            while (_g21 < _g3):
                ...
                while (_g22 < _g31):
                    ...
                    while True:
                        startIndex1 = None
                        if (not ((((txt1.find(sep) if ((startIndex1 is None)) else txt1.find(sep, startIndex1))) >= 0))):
                            break
                        sep = (u"-" + (u"null" if sep is None else sep))
        return sep
    ...
    def addRcNumbers(self,output):
        ...
        if (self.show_rc_numbers and (not self.flags.never_show_order)):
            ...
            _g6 = 1
            _g7 = output.get_width()
            while (_g6 < _g7):
                i3 = _g6
                _g6 = (_g6 + 1)
                unit1 = self.col_map.h.get((i3 - 1),None)
                if (unit1 is None):
                    output.setCell(i3,0,u"")
                    continue
    ...
    def elideColumns(self,output,admin_w):
        if (self.active_column is not None):
            ...
            if (not all_active):
                ...
                _g6 = 0
                while (_g6 < len(dots)):
                    d = (dots[_g6] if _g6 >= 0 and _g6 < len(dots) else None)
                    _g6 = (_g6 + 1)
                    _g61 = 0
                    _g7 = output.get_height()
                    while (_g61 < _g7):
                        j = _g61
                        _g61 = (_g61 + 1)
...
class TableStream(object):
    ...
    def __init__(self,t):
        ...
        if (self.h < 0):
            meta = t.getMeta()
            if (meta is None):
                raise _HxException(u"Cannot get meta information for table")
            self.src = meta.getRowStream()
            if (self.src is None):
                raise _HxException(u"Cannot iterate table")
...
class TerminalDiffRender(object):
    ...
    def pickSizes(self,t):
        ...
        while (_g < _g1):
            ...
            mean = (m / h)
            v1 = ((m2 / h) - ((mean * mean)))
            stddev = (Math.NaN if ((v1 < 0)) else python_lib_Math.sqrt(v1))
            most = None
            try:
            ...
            if (c == unicode):
                ...
                while (_g1 < _g11):
                    ...
                    if (i == last):
                        ...
                        if self.pretty:
                            _this7 = self.buf
                            s7 = u"".join(imap(unichr,[10]))
                            _this7.b.write(s7)
                        if self.pretty:
                            v4 = StringTools.lpad(u"",self.indent,(self.nind * len(self.indent)))
                            _this8 = self.buf
                            s8 = Std.string(v4)
                            _this8.b.write(s8)
                _this9 = self.buf
                s9 = u"".join(imap(unichr,[93]))
                _this9.b.write(s9)
                ...
                while k1.hasNext():
                    ...
                    setattr(o,((u"_hx_" + k2) if ((k2 in python_Boot.keywords)) else ((u"_hx_" + k2) if (((((len(k2) > 2) and ((ord(k2[0]) == 95))) and ((ord(k2[1]) == 95))) and ((ord(k2[(len(k2) - 1)]) != 95)))) else k2)),value)
                v6 = o
    ...
    def fieldsString(self,v,fields):
        ...
        while (_g < _g1):
            ...
            if first:
                ...
                _this1 = self.buf
                s1 = u"".join(imap(unichr,[44]))
                _this1.b.write(s1)
            if self.pretty:
                _this2 = self.buf
                s2 = u"".join(imap(unichr,[10]))
                _this2.b.write(s2)
            if self.pretty:
            ...
            self.quote(f)
            _this4 = self.buf
            s4 = u"".join(imap(unichr,[58]))
            _this4.b.write(s4)
            if self.pretty:
                _this5 = self.buf
                s5 = u"".join(imap(unichr,[32]))
                _this5.b.write(s5)
            self.write(f,value)
            if (i == last):
                _hx_local_2 = self
    ...
    def quote(self,s):
        ...
        while True:
            ...
            if (c1 == 8):
                ...
                _this1 = self.buf
                s2 = u"".join(imap(unichr,[c]))
                _this1.b.write(s2)
        _this2 = self.buf
        s3 = u"".join(imap(unichr,[34]))
        _this2.b.write(s3)
...
class python_Boot(object):
            ...
            if isinstance(o,Enum):
                ...
                if hasParams:
                    ...
                    while (_g3 < _g12):
                        ...
                        if (i1 > 0):
                            prefix1 = u","
                        paramsStr = ((u"null" if paramsStr is None else paramsStr) + HxOverrides.stringOrNull((((u"null" if prefix1 is None else prefix1) + HxOverrides.stringOrNull(python_Boot.toString1(o2.params[i1],s))))))
    ...
    def field(o,field):
        ...
        if isinstance(o,unicode):
            ...
            if (_hx_local_1 == 11):
                if (field3 == u"lastIndexOf"):
                    return python_internal_MethodClosure(o,python_internal_ArrayImpl.lastIndexOf)
                else:
                    field4 = ((u"_hx_" + field) if ((field in python_Boot.keywords)) else ((u"_hx_" + field) if (((((len(field) > 2) and ((ord(field[0]) == 95))) and ((ord(field[1]) == 95))) and ((ord(field[(len(field) - 1)]) != 95)))) else field))
                ...
                elif (field3 == u"reverse"):
                    return python_internal_MethodClosure(o,python_internal_ArrayImpl.reverse)
                elif (field3 == u"unshift"):
                ...
                if (field3 == u"iterator"):
                    return python_internal_MethodClosure(o,python_internal_ArrayImpl.iterator)
                elif (field3 == u"toString"):
                ...
                elif (field3 == u"filter"):
                    return python_internal_MethodClosure(o,python_internal_ArrayImpl.filter)
                elif (field3 == u"insert"):
                    return python_internal_MethodClosure(o,python_internal_ArrayImpl.insert)
                elif (field3 == u"length"):
                    return len(o)
                elif (field3 == u"remove"):
                    return python_internal_MethodClosure(o,python_internal_ArrayImpl.remove)
                elif (field3 == u"splice"):
            ...
            field5 = ((u"_hx_" + field) if ((field in python_Boot.keywords)) else ((u"_hx_" + field) if (((((len(field) > 2) and ((ord(field[0]) == 95))) and ((ord(field[1]) == 95))) and ((ord(field[(len(field) - 1)]) != 95)))) else field))
...
class python_internal_ArrayImpl(object):
    ...
    __slots__ = ()
    _hx_statics = [u"concat", u"copy", u"iterator", u"indexOf", u"lastIndexOf", u"join", u"toString", u"pop", u"push", u"unshift", u"remove", u"shift", u"slice", u"sort", u"splice", u"map", u"filter", u"insert", u"reverse", u"_get", u"_set"]
...
class sys_io_File(object):
    ...
    @staticmethod
    def getContent(path):
        f = python_lib_Builtin.open(path,u"r",-1,u"utf-8",None,u"")
        content = f.read(-1)
        f.close()
        return content
    ...
    def saveContent(path,content):
        f = python_lib_Builtin.open(path,u"w",-1,u"utf-8",None,u"")
        f.write(content)
        f.close()
