...
setup(
    ...
    name='bob.db.drishtigs1',
    version=open("version.txt").read().rstrip(),
    description='Drishti-GS1 Database Access API for Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.drishtigs1',
    license='BSD',
    ...
    keywords = "optic disc segmentation, bob, bob.db, drishti gs1",
    ...
    entry_points={
      ...
      'bob.db': [
        'drishtigs1 = bob.db.drishtigs1.driver:Interface',
      ],
      },
