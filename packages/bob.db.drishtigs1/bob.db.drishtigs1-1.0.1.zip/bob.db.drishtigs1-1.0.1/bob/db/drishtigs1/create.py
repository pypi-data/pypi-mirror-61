...
def add_command(subparsers):
    ...
    parser.add_argument('-D', '--datadir', metavar='DIR', default=bob.extension.rc['bob.db.drishtigs1.datadir'], help='path to Drishti-GS1 dataset, default uses bob config settings (to check use: bob config show).')
    parser.add_argument('-T', '--train', metavar='STR', default='drishtigs1_train_od.csv', help='csv containg train img,gt pairs')
    parser.add_argument('-E', '--test', metavar='STR', default='drishtigs1_test_od.csv', help='csv containg test img,gt pairs')
    parser.add_argument('-O', '--output', metavar='STR', default='drishtigs1_db_default_od.json', help='output file name')
