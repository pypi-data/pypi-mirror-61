...
class FundusImage:
    ...
    def size(self):
        ...
        """
        if bob.extension.rc['bob.db.drishtigs1.datadir']:
            return self.pil_image().size
        else:
            return None


    def pil_image(self, datadir=bob.extension.rc['bob.db.drishtigs1.datadir']):
        """
        Returns
        -------
...
class GroundTruth:
    ...
    def pil_image(self, datadir=bob.extension.rc['bob.db.drishtigs1.datadir']):
        ...
        # we threshold to get gt where all annotators overlap
        gt = gt.point(lambda p: p > 254 and 255)
...
class Sample:
    ...
    .. testsetup:: *
        ...
        from bob.db.drishtigs1.models import *
