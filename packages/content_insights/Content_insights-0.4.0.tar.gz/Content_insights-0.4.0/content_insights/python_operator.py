...
from airflow.operators.bash_operator import BaseOperator, SkipMixin
from airflow.utils.decorators import apply_defaults
from airflow.utils.file import TemporaryDirectory

from textwrap import dedent
from content_insights.stats.prom_statsd import Stats
...
class PythonOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        if self.make_point:
            Stats.gauge(self.customer_name+"."+self.step_name+".duration")
