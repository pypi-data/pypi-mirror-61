...
from authorization.exceptions import NamespaceNotMatch, TokenNotFound
from authorization.util import beautiful_errors, auth_is_enable
from authorization.helpers import AuthorizationHelper
...
class AuthMiddlewareBase:
    ...
    auth_request_property = "tokko-auth"
