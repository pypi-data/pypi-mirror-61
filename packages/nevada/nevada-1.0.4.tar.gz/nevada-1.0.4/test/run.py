import sys
from nevada.API.AdKeyword import *
...
if __name__=="__main__":
    ...
    #lbl-a001-00-000000000106050
    #cmp-a001-01-000000002696103
    #cmp-a001-03-000000002696246

    #stat = Stat(customer_id=customer_id, secret_key=secret_key, api_key=api_key, base_url=base_url)
    # stat.get_by_id(id='cmp-a001-01-000000002696103',
    #                fields='["impCnt","clkCnt","salesAmt","crto"]',
    #                timeRange='{"since":"2020-01-21","until":"2020-01-23"}',
    #                dataPreset='today')
    #stat.get_by_stat_type(id='cmp-a001-01-000000002696103', statType='CAMPAIGN')
