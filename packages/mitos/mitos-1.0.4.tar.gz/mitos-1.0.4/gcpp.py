...
parser.add_option( "-r", "--ref", action = "store", type = "int", metavar = "CODE", help = "reference genetic code" )
        ...
        for y in bases:
            for z in bases:
                ...
                try:
                    ...
                    sys.stdout.write( CodonTable.unambiguous_dna_by_id[i].forward_table[x + y + z] )
