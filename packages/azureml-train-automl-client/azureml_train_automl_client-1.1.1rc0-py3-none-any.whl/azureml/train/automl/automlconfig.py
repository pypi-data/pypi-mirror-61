...
class AutoMLConfig(object):
    ...
    :param featurization:
        ...
        https://docs.microsoft.com/azure/machine-learning/how-to-create-portal-experiments#advanced-featurization-options
    ...
    def __init__(self,
        ...
        :type validation_data: pandas.DataFrame or azureml.core.Dataset
            or azureml.data.dataset_definition.DatasetDefinition or azureml.data.TabularDataset
        :param label_column_name: The name of the label column. (Applicable to training_data
