...
import io
import functools
from typing import Tuple, Iterable, Optional, Union, Callable
...
class Path:
    ...
    def move_to(self,
                ...
                exception_handler: Optional[Callable[[Exception],
                                                     None]] = None):
    ...
    def relative(self, start: Optional[Union['Path', str]] = None) -> str:
        """
    ...
    def open(self,
             mode='r',
             encoding: Union[list, tuple, set, str, Callable] = 'auto'):
        """
    ...
    def collect(self, cond=None) -> 'Iterable[Path]':
    ...
    def __getitem__(self, item: Union[Callable[[str], bool],
                                      int]) -> Optional[str]:
        if callable(item):
