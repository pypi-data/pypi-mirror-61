...
setuptools.setup (
    ...
    license = ("MIT"),
    long_description = "# Conf.py\nConf.py is a small module for configuration. Docs, code examples, etc should be available on https://gitlab.com/Gsbhasin84/configurationpy"
