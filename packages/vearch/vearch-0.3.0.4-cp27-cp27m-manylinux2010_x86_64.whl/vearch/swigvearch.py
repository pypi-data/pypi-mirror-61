...
def MakeRequest(topn, vec_fields, vec_fields_num, fields, fields_num, range_filters, range_filters_num, term_filters, term_filters_num, req_num, direct_search_type, online_log_level, has_rank, multi_vector_rank):
    return _swigvearch.MakeRequest(topn, vec_fields, vec_fields_num, fields, fields_num, range_filters, range_filters_num, term_filters, term_filters_num, req_num, direct_search_type, online_log_level, has_rank, multi_vector_rank)
...
def ByteArrayToUCharVector(value):
    return _swigvearch.ByteArrayToUCharVector(value)
