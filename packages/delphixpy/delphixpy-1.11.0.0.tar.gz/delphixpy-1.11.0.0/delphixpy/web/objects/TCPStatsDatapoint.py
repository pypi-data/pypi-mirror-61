...
class TCPStatsDatapoint(Datapoint):
    ...
    *(extends* :py:class:`delphixpy.web.vo.Datapoint` *)* An analytics
    ...
    def is_dirty(self):
        return any([self._in_unordered_bytes[1], self._retransmitted_bytes[1], self._retransmitted_segs[1], self._unsent_bytes[1], self._in_bytes[1], self._round_trip_time[1], self._receive_window_size[1], self._send_window_size[1], self._unacknowledged_bytes[1], self._congestion_window_size[1], self._out_bytes[1]])
