...
class MSSqlLinkData(LinkData):
    ...
    *(extends* :py:class:`v1_11_0.web.vo.LinkData` *)* MSSQL specific
    ...
    def is_dirty(self):
        return any([self._operations[1], self._mssql_user[1], self._external_file_path[1], self._shared_backup_locations[1], self._config[1], self._encryption_key[1], self._sync_parameters[1], self._backup_location_credentials[1], self._source_host_user[1], self._backup_location_user[1], self._mssql_netbackup_config[1], self._ppt_host_user[1], self._mssql_commvault_config[1], self._staging_pre_script[1], self._ingestion_strategy[1], self._ppt_repository[1], self._staging_post_script[1]])
    ...
    def mssql_user(self):
        ...
        :rtype: :py:class:`v1_11_0.web.vo.MSSqlUser`
        """
