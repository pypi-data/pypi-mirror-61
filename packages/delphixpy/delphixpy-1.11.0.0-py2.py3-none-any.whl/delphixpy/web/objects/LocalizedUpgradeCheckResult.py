...
class LocalizedUpgradeCheckResult(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Describes localized
    ...
    def is_dirty(self):
        return any([self._impact[1], self._unique_identifier[1], self._description[1], self._title[1], self._severity[1], self._action[1], self._output[1], self._response[1], self._bundle_id[1]])
