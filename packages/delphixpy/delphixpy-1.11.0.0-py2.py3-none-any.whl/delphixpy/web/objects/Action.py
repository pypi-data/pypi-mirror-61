...
class Action(PersistentObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.PersistentObject` *)* Represents an
    ...
    def is_dirty(self):
        return any([self._details[1], self._state[1], self._origin_ip[1], self._title[1], self._failure_message_code[1], self._failure_description[1], self._parent_action[1], self._action_type[1], self._user[1], self._start_time[1], self._user_agent[1], self._work_source[1], self._end_time[1], self._failure_action[1], self._work_source_principal[1], self._work_source_name[1]])
