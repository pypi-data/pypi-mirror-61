...
def calculate_robot_speed(prev_location: RobotLocation, next_locations: Mapping[RobotLocation, List[RobotLocationNextStep]]) -> Union[RobotSpeed, EndOfStream]:
    next_location = next_locations[prev_location][0]
    if prev_location.x > 220:
        return EndOfStream()
    return RobotSpeed(
