...
def check_robot_speed(
        ...
        calculated_speeds: Mapping[RobotLocationNextStep, List[RobotSpeed]]
) -> RobotSpeedError:
    next_location = next_locations[prev_location][0]
    calculated_speed = calculated_speeds[next_location][0]
