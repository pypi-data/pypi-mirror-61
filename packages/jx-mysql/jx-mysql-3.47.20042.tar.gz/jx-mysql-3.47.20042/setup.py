...
setup(
    ...
    install_requires=["jx-python>=3.47.20042","mo-collections>=3.46.20032","mo-dots>=3.47.20042","mo-files>=3.41.20031","mo-future>=3.47.20042","mo-json>=3.47.20042","mo-kwargs>=3.47.20042","mo-logs>=3.47.20042","mo-math>=3.41.20031","mo-sql>=3.47.20042","mo-times>=3.46.20032","pyLibrary>=3.47.20042","pymysql"],
    license='MPL 2.0',
