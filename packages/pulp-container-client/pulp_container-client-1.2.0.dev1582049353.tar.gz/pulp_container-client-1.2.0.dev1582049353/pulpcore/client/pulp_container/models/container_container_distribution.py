...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, pulp_href=None, name=None, content_guard=None, repository=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
