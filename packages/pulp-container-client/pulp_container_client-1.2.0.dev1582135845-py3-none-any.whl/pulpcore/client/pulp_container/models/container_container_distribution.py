...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository=None, content_guard=None, pulp_href=None, repository_version=None, pulp_created=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
