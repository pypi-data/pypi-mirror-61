...
def read_lasair_json(object_name='ZTF18acsovsw'):
    ...
    # mjd.extend([58885, 58885])
    # passband.extend([1, 2])
    # mag.extend([18.1, 18])
    # magerr.extend([0.15, 0.15])
    # photflag.extend([4096, 4096])
    # zeropoint.extend([zeropoint[0], zeropoint[5]])
