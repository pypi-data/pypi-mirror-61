#!/usr/bin/env python
#
# dv_pyclient documentation build configuration file, created by
...
version = dv_pyclient.__version__
# The full version, including alpha/beta/rc tags.
release = dv_pyclient.__version__
...
htmlhelp_basename = 'dv_pyclientdoc'
