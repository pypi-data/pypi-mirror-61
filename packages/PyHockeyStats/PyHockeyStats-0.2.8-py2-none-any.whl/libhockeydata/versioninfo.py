...
'''
    ...
    $FileInfo: versioninfo.py - Last Update: 2/17/2020 Ver. 0.2.8 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (0, 2, 8, "RC 1", 1);
__version_date_info__ = (2020, 2, 17, "RC 1", 1);
__version_date__ = str(__version_date_info__[0])+"."+str(__version_date_info__[1]).zfill(2)+"."+str(__version_date_info__[2]).zfill(2);
__revision__ = __version_info__[3];
__revision_id__ = "$Id: 420389155015d678dd586e40e7c5f39b29272a1c $";
#__revision_id__ = re.findall(r"\$Id: 420389155015d678dd586e40e7c5f39b29272a1c $", __full_revision_id__);
