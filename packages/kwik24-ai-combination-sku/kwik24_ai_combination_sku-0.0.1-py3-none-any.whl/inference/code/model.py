...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        self.checkpoint_path = os.path.join(self.model_dir, "mask_rcnn_{}.h5".format(
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers):
        ...
        callbacks = [
            ...
            keras.callbacks.EarlyStopping(monitor='mrcnn_mask_loss', min_delta=0, patience=30, verbose=1, mode='min'),
        ]
