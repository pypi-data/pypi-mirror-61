...
class IsoContourNode(VisusDataflowPy.Node):
    ...
    def __init__(self):
        this = _VisusGuiNodesPy.new_IsoContourNode()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class IsoContourRenderNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self):
        this = _VisusGuiNodesPy.new_IsoContourRenderNode()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class RenderArrayNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self):
        this = _VisusGuiNodesPy.new_RenderArrayNode()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class KdRenderArrayNode(VisusDataflowPy.Node, VisusGuiPy.GLObject):
    ...
    def __init__(self):
        this = _VisusGuiNodesPy.new_KdRenderArrayNode()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
