...
class XDbModule(VisusKernelPy.VisusModule):
    __swig_setmethods__ = {}
    for _s in [VisusKernelPy.VisusModule]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, XDbModule, name, value)
    __swig_getmethods__ = {}
    for _s in [VisusKernelPy.VisusModule]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, XDbModule, name)
    __repr__ = _swig_repr
    __swig_setmethods__["bAttached"] = _VisusXIdxPy.XDbModule_bAttached_set
    __swig_getmethods__["bAttached"] = _VisusXIdxPy.XDbModule_bAttached_get
    if _newclass:
        bAttached = _swig_property(_VisusXIdxPy.XDbModule_bAttached_get, _VisusXIdxPy.XDbModule_bAttached_set)
    if _newclass:
        attach = staticmethod(_VisusXIdxPy.XDbModule_attach)
    else:
        attach = _VisusXIdxPy.XDbModule_attach
    if _newclass:
        detach = staticmethod(_VisusXIdxPy.XDbModule_detach)
    else:
        detach = _VisusXIdxPy.XDbModule_detach

    def __init__(self):
        this = _VisusXIdxPy.new_XDbModule()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _VisusXIdxPy.delete_XDbModule
    __del__ = lambda self: None
XDbModule_swigregister = _VisusXIdxPy.XDbModule_swigregister
XDbModule_swigregister(XDbModule)
cvar = _VisusXIdxPy.cvar

def XDbModule_attach():
    return _VisusXIdxPy.XDbModule_attach()
XDbModule_attach = _VisusXIdxPy.XDbModule_attach

def XDbModule_detach():
    return _VisusXIdxPy.XDbModule_detach()
XDbModule_detach = _VisusXIdxPy.XDbModule_detach
