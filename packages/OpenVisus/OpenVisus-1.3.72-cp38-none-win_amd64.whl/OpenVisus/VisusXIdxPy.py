...
class XDbModule(VisusKernelPy.VisusModule):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    bAttached = property(_VisusXIdxPy.XDbModule_bAttached_get, _VisusXIdxPy.XDbModule_bAttached_set)
    ...
    def __init__(self):
        _VisusXIdxPy.XDbModule_swiginit(self, _VisusXIdxPy.new_XDbModule())
    __swig_destroy__ = _VisusXIdxPy.delete_XDbModule

# Register XDbModule in _VisusXIdxPy:
_VisusXIdxPy.XDbModule_swigregister(XDbModule)
