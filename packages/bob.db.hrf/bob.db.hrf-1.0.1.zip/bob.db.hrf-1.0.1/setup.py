...
setup(
    ...
    description='HRF Database Access API for Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.hrf',
    license='BSD',
    ...
    keywords = "retinal vessel segmentation, bob, bob.db, hrf",
    ...
    entry_points={
      ...
      'bob.db': [
        'hrf = bob.db.hrf.driver:Interface',
      ],
      },
