...
def add_command(subparsers):
    ...
    parser.add_argument('-T', '--train', metavar='STR', default='hrf_train.csv', help='csv containg train img,gt pairs')
    parser.add_argument('-E', '--test', metavar='STR', default='hrf_test.csv', help='csv containg test img,gt pairs')
    parser.add_argument('-O', '--output', metavar='STR', default='hrf_db_default.json', help='output file name')
