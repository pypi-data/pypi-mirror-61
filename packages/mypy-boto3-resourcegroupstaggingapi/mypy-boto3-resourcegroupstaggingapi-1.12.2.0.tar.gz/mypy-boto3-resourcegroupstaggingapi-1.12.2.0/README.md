...
[boto3.ResourceGroupsTaggingAPI 1.12.2](https://boto3.amazonaws.com/v1/documentation/api/1.12.2/reference/services/resourcegroupstaggingapi.html#ResourceGroupsTaggingAPI) service
