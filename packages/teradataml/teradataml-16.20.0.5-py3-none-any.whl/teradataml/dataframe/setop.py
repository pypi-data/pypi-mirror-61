...
def __check_concat_compatibility(df_list, join, sort):
    """
    DESCRIPTION:
...
def concat(df_list, join='OUTER', allow_duplicates=True, sort=False):
    """
    DESCRIPTION:
    ...
    master_columns_dict, is_lazy = __check_concat_compatibility(df_list, join, sort)
