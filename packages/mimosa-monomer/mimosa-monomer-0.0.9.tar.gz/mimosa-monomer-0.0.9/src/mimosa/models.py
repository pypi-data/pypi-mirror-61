...
class FirebaseDocClass(ABC):
    """Abstract class for from_firestore_doc interface"""

    @classmethod
    @abstractmethod
    def from_firestore_doc(cls, doc: DocumentSnapshot):
        return cls
...
class SiteKey:
    ...
    timezone: str = attrib(validator=attr.validators.instance_of(str))
    managingCompanyID: str = attrib(validator=attr.validators.instance_of(str))
    validCraftTypes: List[int] = attrib(validator=attr.validators.instance_of(list))
    validTaskTypes: List[int] = attrib(validator=attr.validators.instance_of(list))
    validTaskStatusCodes: List[int] = attrib(
        validator=attr.validators.instance_of(list)
    )
    validEventTypes: List[int] = attrib(validator=attr.validators.instance_of(list))
    customizations: Dict[str, Any] = attrib(validator=attr.validators.instance_of(dict))
...
class SiteKeyCompany:
    name: str = attrib(validator=attr.validators.instance_of(str))
    craft_types: List[int] = attrib(validator=attr.validators.instance_of(list))

    main_point_of_contact: Optional[str] = attrib(
        validator=attr.validators.optional(attr.validators.instance_of(str))
    )
    logo_photo_url: Optional[str] = attrib(
        validator=attr.validators.optional(attr.validators.instance_of(str))
    )
    members: List[str] = attrib(validator=attr.validators.instance_of(list))
...
@attrs
class SiteKeyUser(FirebaseDocClass):
    id: Union[str, None] = attrib(
        validator=attr.validators.optional(attr.validators.instance_of(str))
    )
    ref_path: Union[str, None] = attrib(
        validator=attr.validators.optional(attr.validators.instance_of(str))
    )
    display_name: str = attrib(validator=attr.validators.instance_of(str))
    company_name: str = attrib(validator=attr.validators.instance_of(str))
    job_title: str = attrib(validator=attr.validators.instance_of(str))
    email: str = attrib(validator=attr.validators.instance_of(str))
    department: str = attrib(validator=attr.validators.instance_of(str))
    phone: str = attrib(validator=attr.validators.instance_of(str))
    user_photo_url: Union[str, None] = attrib(
        validator=attr.validators.optional(attr.validators.instance_of(str))
    )

    @classmethod
    def from_firestore_doc(
        cls, doc: firestore.firestore.DocumentSnapshot,
    ):
        return cls(
            id=doc.id,
            ref_path=doc.reference.path,
            ...
            phone=doc.get("phone"),
            user_photo_url=doc.get("userPhoto_URL"),
        )
