...
class Example:
    ...
    def __init__(self):
        ...
        # Initialize
        directory = os.path.join(str(Path.home()), "geoname_test") #"Documents", "geoname_data")
        self.geodata = Geodata.Geodata(directory_name=directory, display_progress=None,
                                       show_message=False, exit_on_error=True,
    ...
    def lookup_place(self, location_name):
        ...
        if match:
            ...
            print(f'   Best match for {location_name}:\n {nm}  Prefix=[{place.prefix}] Score= {place.score:.1f}\n')
        else:
