...
class Package(SirenComponent):
    ...
    def register_package(
        ...
        :param str internal_data: Accepted values are: `Yes`, `No` or `Both`. Package is marked as `Yes` if underlying data is created internally at IHS Markit, or No if externally, e.g. S&P, Russell, etc.
