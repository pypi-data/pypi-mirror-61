...
from harix.rdk.proto.robot_skill_api import robot_control_api_pb2 as robot__skill__api_dot_robot__control__api__pb2
...
class RobotControlServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.StartScreenShot = channel.unary_unary(
        '/robotSkillApi.RobotControlService/StartScreenShot',
        request_serializer=robot__skill__api_dot_robot__control__api__pb2.StartScreenShotRequest.SerializeToString,
        response_deserializer=robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
...
class RobotControlServiceServicer(object):
  ...
  def StartScreenShot(self, request, context):
    """控制短视频与截图录制
    """
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_RobotControlServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'StartScreenShot': grpc.unary_unary_rpc_method_handler(
          servicer.StartScreenShot,
          request_deserializer=robot__skill__api_dot_robot__control__api__pb2.StartScreenShotRequest.FromString,
          response_serializer=robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
  }
