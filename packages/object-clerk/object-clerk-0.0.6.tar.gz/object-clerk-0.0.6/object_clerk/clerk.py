...
class ObjectClerk:
    ...
    @mutate_client_exceptions
    def _list_objects(self, bucket: str, max_keys: int) -> Tuple[Optional[List[dict]], Optional[bool]]:
        """
    ...
    def list_objects(self, bucket: str, max_keys: int = 1000) -> Tuple[Optional[List[dict]], Optional[bool]]:
        """
