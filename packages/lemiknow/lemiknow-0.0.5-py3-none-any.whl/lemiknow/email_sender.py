        ...
        def wrapper_sender(*args, **kwargs):
            ...
            if master_process:
                ...
                for i in range(len(recipient_emails)):
                    ...
                    yag_sender.send(current_recipient,
                                    'Training has started 🎬', contents)
            try:
                ...
                if master_process:
                    ...
                    for i in range(len(recipient_emails)):
                        current_recipient = recipient_emails[i]
                        yag_sender.send(
                            current_recipient, 'Training has sucessfully finished 🎉', contents)
                ...
                for i in range(len(recipient_emails)):
                    current_recipient = recipient_emails[i]
                    yag_sender.send(current_recipient,
                                    'Training has crashed ☠️', contents)
                raise ex
