...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/glemaitre/Documents/packages/imbalanced-learn/examples/under-sampling/plot_illustration_tomek_links.py:99: UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure.
      plt.show()
