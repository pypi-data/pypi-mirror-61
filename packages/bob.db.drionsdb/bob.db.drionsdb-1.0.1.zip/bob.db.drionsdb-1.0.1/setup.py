...
setup(
    ...
    name='bob.db.drionsdb',
    version=open("version.txt").read().rstrip(),
    description='DRIONS-DB Database Access API for Bob',

    url='https://gitlab.idiap.ch/bob/bob.db.drionsdb',
    license='BSD',
    ...
    keywords = "optic disc segmentation, bob, bob.db, drions",
    ...
    entry_points={
      ...
      'bob.db': [
        'drionsdb = bob.db.drionsdb.driver:Interface',
      ],
      },
