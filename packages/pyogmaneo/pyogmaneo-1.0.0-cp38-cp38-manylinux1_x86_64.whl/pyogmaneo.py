...
class ComputeSystem(object):
    ...
    def __init__(self, numWorkers, seed=1234):
        _pyogmaneo.ComputeSystem_swiginit(self, _pyogmaneo.new_ComputeSystem(numWorkers, seed))
...
class Hierarchy(object):
    ...
    def step(self, cs, inputCs, learnEnabled=True, reward=0.0):
        return _pyogmaneo.Hierarchy_step(self, cs, inputCs, learnEnabled, reward)
    ...
    def setSCExplainIters(self, l, explainIters):
        return _pyogmaneo.Hierarchy_setSCExplainIters(self, l, explainIters)

    def getSCExplainIters(self, l):
        return _pyogmaneo.Hierarchy_getSCExplainIters(self, l)
