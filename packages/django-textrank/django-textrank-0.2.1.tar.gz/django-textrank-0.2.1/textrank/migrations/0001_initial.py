    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=django.utils.crypto.get_random_string, error_messages={'unique': 'Такой код уже существует.'}, help_text='Обязательно. 32 символов и менее, уникальное значение.', max_length=32, unique=True, verbose_name='код группы')),
