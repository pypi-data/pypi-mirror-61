...
def put_directory(data_dir, bucket_name, object_name_prefix, metadata, storage_class=None):
...
def put_object(data_file, bucket_name, object_name, metadata, storage_class=None):
  check_bucket_name(bucket_name)
  ...
  if storage_class:
    fds_metadata.add_header(Common.STORAGE_CLASS, storage_class)
