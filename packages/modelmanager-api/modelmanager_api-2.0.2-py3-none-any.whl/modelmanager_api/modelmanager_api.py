...
class Model(ModelManager):
    ...
    def post_model(self, model_data):
        ...
        model_file_path_f = model_data['model_file_path']
        scoring_file_path_f = model_data['scoring_file_path']

        try:
            model_file_path = open(model_file_path_f, 'rb')
        except:
            model_file_path = None
        
        try:
            scoring_file_path = open(scoring_file_path_f, 'rb')
        except:
