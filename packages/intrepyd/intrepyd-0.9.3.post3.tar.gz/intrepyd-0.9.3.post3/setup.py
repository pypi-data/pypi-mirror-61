...
libraries = None
if system_str == 'Linux':
    libraries = [(str(os.path.join(site.getusersitepackages(), 'intrepyd')), ['libs/linux64/_api.so'])]
    # libraries = [('/home/roberto/.local/lib/python3.7/site-packages/intrepyd', ['libs/linux64/_api.so'])]
