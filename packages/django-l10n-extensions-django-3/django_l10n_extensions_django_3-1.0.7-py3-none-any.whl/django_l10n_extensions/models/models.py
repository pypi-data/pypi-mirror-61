...
class L10n(models.Model):
    ...
    unit_distance = models.CharField(choices=DISTANCE_CHOICES, max_length=29, null=True, blank=True)
    unit_area = models.CharField(choices=AREA_CHOICES, max_length=32, null=True, blank=True)
    unit_weight= models.CharField(choices=WEIGHT_CHOICES, max_length=24, null=True, blank=True)
    unit_volume = models.CharField(choices=VOLUME_CHOICES, max_length=32, null=True, blank=True)
