...
class MetadataClientTest(ModuleBase, unittest.TestCase):
    ...
    def test_get_proposal_experiments(self):
        proposal_number = 0
        resp = MetadataClient.get_proposal_experiments(self.mdc_client,
                                                       proposal_number)
    ...
    def test_get_proposal_runs(self):
        proposal_number = 0
        resp = MetadataClient.get_proposal_runs(self.mdc_client,
                                                proposal_number)
    ...
    def test_get_proposal_samples(self):
        proposal_number = 0
        resp = MetadataClient.get_proposal_samples(self.mdc_client,
                                                   proposal_number)
    ...
    def test_register_run_with_invalid_keys(self):
        ...
        resp = MetadataClient.register_run(self.mdc_client,
    ...
    def test_register_run_data_with_invalid_keys(self):
        ...
        resp = MetadataClient.register_run_data(self.mdc_client,
                                                experiment_id,
                                                sample_id,
                                                run_id,
                                                data_group_id,
    ...
    def test_close_run_with_keys_of_wrong_type(self):
        ...
        resp = MetadataClient.close_run(self.mdc_client,
                                        experiment_id,
                                        sample_id,
                                        run_id,
                                        data_group_id,
    ...
    def test_register_run_replica_with_success(self):
        ...
        resp_reg = MetadataClient.register_run_replica(self.mdc_client,
                                                       proposal_number,
                                                       run_number,
