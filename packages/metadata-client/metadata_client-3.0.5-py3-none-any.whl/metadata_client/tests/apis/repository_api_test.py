...
class RepositoryApiTest(ApiBase, unittest.TestCase):
    ...
    def fields_validation(self, receive, expect):
        ...
        self.assert_eq_hfield(receive, expect, 'transfer_agent_identifier',
                              STRING),
        self.assert_eq_hfield(receive, expect, 'transfer_agent_server_url',
                              STRING),
        ...
        repository_upd = {
            'repository': {
                ...
                'transfer_agent_server_url':
                    'updated_repo_address:update_repo_port',
                'flg_context': 'R',
                'flg_available': 'false',
