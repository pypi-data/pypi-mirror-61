...
|Requirements| |CircleCI| |codecov| |docker-simonsdave/bionic-dev-env|
...
-  `shell and python
   scripts <https://github.com/simonsdave/dev-env/tree/release-0.6.6/bin>`__
...
-  `here’s <https://github.com/simonsdave/dev-env/tree/release-0.6.6/docs/using.md>`__
...
-  if you’d like to help contribute to ``dev-env`` see
   `this <https://github.com/simonsdave/dev-env/tree/release-0.6.6/docs/contributing.md>`__
...
.. |codecov| image:: https://codecov.io/gh/simonsdave/dev-env/branch/master/graph/badge.svg
   :target: https://codecov.io/gh/simonsdave/dev-env/branch/master
