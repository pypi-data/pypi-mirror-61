...
class BackgroundTask:
    def __init__(self, id, method, delay, name=None, max_callings=None):
        if name is None:
...
class AbstractBackgroundTaskRunner():
    ...
    def register_background_task(self, method, minimum_call_delay=None, max_callings=None,name=None):
