...
class DatabaseConnection:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'engine', None, None, ), # 1
    (2, TType.STRING, 'host', None, None, ), # 2
    (3, TType.I32, 'port', None, None, ), # 3
    (4, TType.STRING, 'username_b64', None, None, ), # 4
    (5, TType.STRING, 'password_b64', None, None, ), # 5
    (6, TType.STRING, 'database', None, None, ), # 6
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.username_b64 = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.STRING:
          self.password_b64 = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.STRING:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.username_b64)
    value = (value * 31) ^ hash(self.password_b64)
...
class ProductConfiguration:
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'displayedName_b64', None, None, ), # 3
    (4, TType.STRING, 'description_b64', None, None, ), # 4
    (5, TType.STRUCT, 'connection', (DatabaseConnection, DatabaseConnection.thrift_spec), None, ), # 5
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.displayedName_b64 = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
          self.description_b64 = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.displayedName_b64)
    value = (value * 31) ^ hash(self.description_b64)
    value = (value * 31) ^ hash(self.connection)
    value = (value * 31) ^ hash(self.runLimit)
    value = (value * 31) ^ hash(self.isReviewStatusChangeDisabled)
    return value
...
class Product:
  ...
  thrift_spec = (
    ...
    (10, TType.STRING, 'latestStoreToProduct', None, None, ), # 10
    (11, TType.I64, 'runLimit', None, None, ), # 11
    (12, TType.LIST, 'admins', (TType.STRING,None), None, ), # 12
    (13, TType.LIST, 'runStoreInProgress', (TType.STRING,None), None, ), # 13
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.latestStoreToProduct = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.I64:
  ...
  def write(self, oprot):
    ...
    if self.latestStoreToProduct is not None:
      ...
      oprot.writeString(self.latestStoreToProduct)
      oprot.writeFieldEnd()
    if self.runLimit is not None:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.displayedName_b64)
    value = (value * 31) ^ hash(self.description_b64)
    value = (value * 31) ^ hash(self.connected)
    value = (value * 31) ^ hash(self.accessible)
    value = (value * 31) ^ hash(self.administrating)
    value = (value * 31) ^ hash(self.databaseStatus)
    value = (value * 31) ^ hash(self.runCount)
    value = (value * 31) ^ hash(self.latestStoreToProduct)
    value = (value * 31) ^ hash(self.runLimit)
    value = (value * 31) ^ hash(self.admins)
    value = (value * 31) ^ hash(self.runStoreInProgress)
    return value
