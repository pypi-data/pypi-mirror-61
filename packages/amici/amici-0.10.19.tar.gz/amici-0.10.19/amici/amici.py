...
class ModelPtr(object):
    ...
    dxdotdp_explicit = property(_amici.ModelPtr_dxdotdp_explicit_get, _amici.ModelPtr_dxdotdp_explicit_set, doc=r"""
    ...
    """)
    dxdotdp_implicit = property(_amici.ModelPtr_dxdotdp_implicit_get, _amici.ModelPtr_dxdotdp_implicit_set, doc=r"""
    ...
    def fdxdotdp(self, t, x, dx):
        r"""
        Model specific sparse implementation of
    ...
    def fdwdp_colptrs(self, indexptrs):
        r"""
    ...
    def fdwdp_rowvals(self, indexvals):
        r"""
...
class Model(AbstractModel):
    ...
    dxdotdp_explicit = property(_amici.Model_dxdotdp_explicit_get, _amici.Model_dxdotdp_explicit_set, doc=r"""
    temporary storage of dxdotdp data across functions, Python only
        (dimension: nplist x nx_solver, nnz: ndxdotdp_explicit, type CSC_MAT)
    """)
    dxdotdp_implicit = property(_amici.Model_dxdotdp_implicit_get, _amici.Model_dxdotdp_implicit_set, doc=r"""
    temporary storage of dxdotdp_implicit data across functions, Python only
        (dimension: nplist x * nx_solver, nnz: ndxdotdp_implicit, type CSC_MAT)
    """)
