...
class HttpNtlmAuth(AuthBase):
    ...
    def __init__(self, username, password, send_cbt=True):
        ...
        logger.debug("Domain/username: %s/%s", self.domain, self.username)
    ...
    def retry_using_http_ntlm_auth(
        ...
        logger.debug("request.headers auth_header: %s", request.headers[auth_header])
