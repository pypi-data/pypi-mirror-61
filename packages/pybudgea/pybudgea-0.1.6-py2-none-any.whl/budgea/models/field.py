...
class Field(object):
    ...
    def __init__(self, auth_mechanisms=None, ephemeral=False, id=None, id_connector=None, label=None, name=None, regex=None, required=True, type='text', value=None):  # noqa: E501
        """Field - a model defined in OpenAPI"""  # noqa: E501

        self._auth_mechanisms = None
        ...
        if auth_mechanisms is not None:
    ...
    @property
    def auth_mechanisms(self):
        """Gets the auth_mechanisms of this Field.  # noqa: E501

        Authentication mechanisms this field is used for  # noqa: E501

        :return: The auth_mechanisms of this Field.  # noqa: E501
        :rtype: str
        """
        return self._auth_mechanisms

    @auth_mechanisms.setter
    def auth_mechanisms(self, auth_mechanisms):
        """Sets the auth_mechanisms of this Field.

        Authentication mechanisms this field is used for  # noqa: E501

        :param auth_mechanisms: The auth_mechanisms of this Field.  # noqa: E501
        :type: str
        """

        self._auth_mechanisms = auth_mechanisms
