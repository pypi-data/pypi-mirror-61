...
class Account(object):
    ...
    def __init__(self, balance=None, bookmarked=None, coming=0.0, company_name=None, currency=None, deleted=None, disabled=None, display=True, error=None, iban=None, id=None, id_connection=None, id_parent=None, id_source=None, id_type=None, id_user=None, last_update=None, name=None, number=None, original_name=None, ownership=None, usage=None, webid=None):  # noqa: E501
    ...
    def company_name(self):
        ...
        Name of the company holding the employee savings of the account  # noqa: E501
    ...
    @property
    def id_source(self):
        """Gets the id_source of this Account.  # noqa: E501

        ID of the related connection source  # noqa: E501

        :return: The id_source of this Account.  # noqa: E501
        :rtype: int
        """
    ...
    def id_source(self, id_source):
        """Sets the id_source of this Account.

        ID of the related connection source  # noqa: E501

        :param id_source: The id_source of this Account.  # noqa: E501
        :type: int
        """
    ...
    def usage(self):
        ...
        Account usage (if not set by the user, displays the value of original_usage)  # noqa: E501
