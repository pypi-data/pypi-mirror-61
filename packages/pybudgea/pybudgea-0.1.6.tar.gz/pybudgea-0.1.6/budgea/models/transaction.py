...
class Transaction(object):
    ...
    def __init__(self, active=True, application_date=None, bdate=None, card=None, coming=None, comment=None, commission=None, commission_currency=None, counterparty=None, country=None, date=None, date_scraped=None, deleted=None, gross_value=None, id=None, id_account=None, id_category=None, id_cluster=None, last_update=None, nature='inconnu', original_currency=None, original_gross_value=None, original_value=None, original_wording=None, rdate=None, simplified_wording=None, state='new', stemmed_wording=None, value=None, vdate=None, webid=None, wording=None):  # noqa: E501
        ...
        self._original_gross_value = None
        ...
        if original_gross_value is not None:
            self.original_gross_value = original_gross_value
    ...
    @property
    def original_gross_value(self):
        """Gets the original_gross_value of this Transaction.  # noqa: E501

        Gross value in the original currency  # noqa: E501

        :return: The original_gross_value of this Transaction.  # noqa: E501
        :rtype: float
        """
        return self._original_gross_value

    @original_gross_value.setter
    def original_gross_value(self, original_gross_value):
        """Sets the original_gross_value of this Transaction.

        Gross value in the original currency  # noqa: E501

        :param original_gross_value: The original_gross_value of this Transaction.  # noqa: E501
        :type: float
        """

        self._original_gross_value = original_gross_value
