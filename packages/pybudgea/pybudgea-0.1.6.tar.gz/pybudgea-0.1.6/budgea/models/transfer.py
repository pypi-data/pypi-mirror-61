...
class Transfer(object):
    ...
    def __init__(self, account_balance=None, account_iban=None, amount=None, beneficiary_label=None, beneficiary_number=None, beneficiary_type='recipient', currency=None, error=None, exec_date=None, fees=None, id=None, id_account=None, id_recipient=None, id_transaction=None, id_user=None, label=None, recipient_iban=None, register_date=None, state=None, validate_mechanism=None, webid=None):  # noqa: E501
        """Transfer - a model defined in OpenAPI"""  # noqa: E501

        self._account_balance = None
        self._account_iban = None
        self._amount = None
        self._beneficiary_label = None
        self._beneficiary_number = None
        ...
        if beneficiary_label is not None:
            self.beneficiary_label = beneficiary_label
        if beneficiary_number is not None:
            self.beneficiary_number = beneficiary_number
        ...
        self.state = state
        if validate_mechanism is not None:
            self.validate_mechanism = validate_mechanism
    ...
    def beneficiary_label(self):
        """Gets the beneficiary_label of this Transfer.  # noqa: E501

        Label of the beneficiary (needed for transfer to other beneficiary type than 'recipient')  # noqa: E501

        :return: The beneficiary_label of this Transfer.  # noqa: E501
        :rtype: str
        """
        return self._beneficiary_label

    @beneficiary_label.setter
    def beneficiary_label(self, beneficiary_label):
        """Sets the beneficiary_label of this Transfer.

        Label of the beneficiary (needed for transfer to other beneficiary type than 'recipient')  # noqa: E501

        :param beneficiary_label: The beneficiary_label of this Transfer.  # noqa: E501
        :type: str
        """

        self._beneficiary_label = beneficiary_label

    @property
    def beneficiary_number(self):
        """Gets the beneficiary_number of this Transfer.  # noqa: E501

        Beneficiary bank identifier value like recipient webid, iban: EX6713281847025300290000062 or phone_number: 06XXXXXX  # noqa: E501

        :return: The beneficiary_number of this Transfer.  # noqa: E501
        :rtype: str
        """
        return self._beneficiary_number

    @beneficiary_number.setter
    def beneficiary_number(self, beneficiary_number):
        """Sets the beneficiary_number of this Transfer.

        Beneficiary bank identifier value like recipient webid, iban: EX6713281847025300290000062 or phone_number: 06XXXXXX  # noqa: E501

        :param beneficiary_number: The beneficiary_number of this Transfer.  # noqa: E501
        :type: str
        """

        self._beneficiary_number = beneficiary_number

    @property
    def beneficiary_type(self):
        """Gets the beneficiary_type of this Transfer.  # noqa: E501

        Type of beneficiary number, for example: 'recipient' (in bank recipient list), 'iban' or 'phone_number'  # noqa: E501

        :return: The beneficiary_type of this Transfer.  # noqa: E501
        :rtype: str
        """
    ...
    def beneficiary_type(self, beneficiary_type):
        """Sets the beneficiary_type of this Transfer.

        Type of beneficiary number, for example: 'recipient' (in bank recipient list), 'iban' or 'phone_number'  # noqa: E501

        :param beneficiary_type: The beneficiary_type of this Transfer.  # noqa: E501
        :type: str
        """
        if beneficiary_type is None:
            raise ValueError("Invalid value for `beneficiary_type`, must not be `None`")  # noqa: E501
    ...
    def validate_mechanism(self):
        """Gets the validate_mechanism of this Transfer.  # noqa: E501

        Authentication method used to validate transfer (credentials or webauth)  # noqa: E501

        :return: The validate_mechanism of this Transfer.  # noqa: E501
        :rtype: str
        """
        return self._validate_mechanism

    @validate_mechanism.setter
    def validate_mechanism(self, validate_mechanism):
        """Sets the validate_mechanism of this Transfer.

        Authentication method used to validate transfer (credentials or webauth)  # noqa: E501

        :param validate_mechanism: The validate_mechanism of this Transfer.  # noqa: E501
        :type: str
        """

        self._validate_mechanism = validate_mechanism
