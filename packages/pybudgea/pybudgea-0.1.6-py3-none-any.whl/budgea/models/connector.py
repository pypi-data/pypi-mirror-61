...
class Connector(object):
    ...
    def __init__(self, auth_mechanism=None, beta=False, charged=True, code=None, color=None, hidden=False, id=None, months_to_fetch=None, name=None, restricted=False, siret=None, slug=None, sync_frequency=None, uuid=None):  # noqa: E501
    ...
    @property
    def restricted(self):
        """Gets the restricted of this Connector.  # noqa: E501

        If true, new connections cannot be added with this connector  # noqa: E501

        :return: The restricted of this Connector.  # noqa: E501
        :rtype: bool
        """
    ...
    def restricted(self, restricted):
        """Sets the restricted of this Connector.

        If true, new connections cannot be added with this connector  # noqa: E501

        :param restricted: The restricted of this Connector.  # noqa: E501
        :type: bool
        """
        if restricted is None:
            raise ValueError("Invalid value for `restricted`, must not be `None`")  # noqa: E501
