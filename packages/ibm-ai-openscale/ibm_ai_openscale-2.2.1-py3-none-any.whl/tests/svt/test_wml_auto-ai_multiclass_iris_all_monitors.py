...
from utils.wml_deployments.auto_ai import Iris
...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_15_send_feedback_data(self):
        ...
        for i in range(0, int(self.feedback_records/5)):
            feedback_records.append([5.4,3.4,1.5,0.4, 'setosa'])
            feedback_records.append([6.5,2.8,4.6,1.5, 'versicolor'])
            feedback_records.append([5.7, 2.8,4.1,1.3, 'versicolor'])
            feedback_records.append([6.5,3.2,5.1,2.0, 'virginica'])
            feedback_records.append([6.3,2.5,5.0,1.9, 'virginica'])
