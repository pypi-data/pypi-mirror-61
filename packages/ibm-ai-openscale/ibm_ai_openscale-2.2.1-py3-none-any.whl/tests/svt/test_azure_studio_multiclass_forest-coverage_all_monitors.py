...
class TestAIOpenScaleClient(unittest.TestCase):
                    ...
                    [
                        {
                            ...
                            'Soil_Type': 'Como family - Rock land - Legault family complex, extremely stonyComo family - Rock land - Legault family complex, extremely stony'
                        }
                    ],
            },
            "GlobalParameters": {
    ...
    def test_04_get_assets(self):
        ...
        # asset_details = self.ai_client.data_mart.bindings.list_assets()
        # print("Assets details: ".format(asset_details))
        #
        # asset_details = self.ai_client.data_mart.bindings.get_asset_deployment_details()
        # print("Assets details: ".format(asset_details))

        for detail in asset_details:
            if 'forestcover.multiclass' in detail['name']:
    ...
    def test_05_subscribe_azure_asset(self):
        subscription = self.ai_client.data_mart.subscriptions.add(
            AzureMachineLearningStudioAsset(source_uid=self.source_uid,
                                            ...
                                            categorical_columns=['Wilderness_Area']))
