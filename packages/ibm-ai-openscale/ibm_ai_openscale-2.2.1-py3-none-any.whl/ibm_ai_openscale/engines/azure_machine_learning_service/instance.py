...
class AzureMachineLearningServiceInstance(AIInstance):
    """
    ...
    >>> }
    >>>
    >>> client.bindings.add("Azure instance A", AzureMachineLearningServiceInstance(credentials))
    """
    ...
    def __init__(self, service_credentials):
        ...
        AIInstance.__init__(self, str(uuid.uuid4()), service_credentials, AzureServiceConsts.SERVICE_TYPE)
