...
class AzureMachineLearningStudioAsset(KnownServiceAsset):
    """
    ...
    >>>
    >>> AzureMachineLearningStudioAsset(source_uid=uid, binding_uid=binding_uid, input_data_type=InputDataType.STRUCTURED,
    >>>         problem_type=ProblemType.BINARY_CLASSIFICATION, label_column='label', prediction_column='Scored Labels')
    """
    service_type = AzureStudioConsts.SERVICE_TYPE
