...
class ISidecarConfiguration(metaclass=ABCMeta):
    def __init__(self,
                 ...
                 env_type: str,
                 is_private_environment: bool):
        self.is_private_environment = is_private_environment
...
class AzureSidecarConfiguration(ISidecarConfiguration):
    def __init__(self,
        ...
        super().__init__(environment, "azure", sandbox_id, production_id, space_id, cloud_external_key, apps, services,
                         messaging,
                         env_type, is_private_environment)
    ...
    def __eq__(self, other):
        if isinstance(self, other.__class__):
            return self.management_resource_group == other.management_resource_group and \
                   ...
                   self.is_private_environment == other.is_private_environment
        return False
    ...
    def __repr__(self):
        return "management_resource_group={} " \
               ...
               "messaging={} " \
               "vnet_name={} " \
               "is_private_environment={}".format(self.management_resource_group,
...
class AwsSidecarConfiguration(ISidecarConfiguration):
    ...
    def __repr__(self):
        return "region_name={} " \
               ...
               "onboarding_region={} " \
               "data_table_name={} " \
               "is_private_environment={}".format(self.region_name,
...
class KubernetesSidecarConfiguration(ISidecarConfiguration):
    ...
    def __repr__(self):
        return "kub_api_address={} " \
               ...
               "services={} " \
               "messaging={} " \
               "is_private_environment={}".format(self.kub_api_address,
                                                  self.environment,
                                                  self.provider,
                                                  self.sandbox_id,
                                                  self.production_id,
