...
import aiohttp
import requests
from mclimate.exceptions import ApiException, UnsupportedDevice

from mclimate import CHANGE_TIME_CACHE_DEFAULT, HEADERS, MCLIMATE_URL, \
    CLIENT_DATA
from mclimate.core import CoreDevices

LOGGER = logging.getLogger(__name__)


class AsyncMclimate(CoreDevices):
    """
    Async class for Mclimate.
    """
    session = None

    def __init__(self, **kwargs):
        super(AsyncMclimate, self).__init__(**kwargs)
