...
class SignalParalleLauncher():
    def __init__(self,drop_token='', dropbox_backup=True, local_root_directory='../data',user='napoleon',  db_path_suffix = '_run.sqlite', signal_types=['dd_threshold'] ,lookback_windows=[5], thresholds=[1.], contravariants=[1.]):
        self.args = []
        self.counter = 1
        self.seed = 0
            ...
            for w in lookback_windows:
                for t in thresholds:
                    for c in contravariants:
                        self.args.append((self,self.seed,signal_type, w,t,c))
