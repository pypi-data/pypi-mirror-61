...
class FeaturesAssembler(AbstractAssembler):
    ...
    def preprocessReturns(self, lookback_window, ts_fresh_indices = ['SPXT', 'SX5T'], add_signal_predictor = False):
        ...
        if add_signal_predictor:
            advanced_signals_ts_features = buildAdvancedPriceFeatures(quotes_df=df[strats], max_timeshift=self.max_timeshift,
