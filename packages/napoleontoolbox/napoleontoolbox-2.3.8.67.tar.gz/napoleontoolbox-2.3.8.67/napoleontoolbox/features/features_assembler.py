...
class FeaturesAssembler(AbstractAssembler):
    ...
    def preprocessReturns(self, lookback_window):
        ...
        advanced_ts_features = buildAdvancedPriceFeatures(quotes_df=df[strats],lookback_window=lookback_window, rolling_direction=self.rolling_direction)
