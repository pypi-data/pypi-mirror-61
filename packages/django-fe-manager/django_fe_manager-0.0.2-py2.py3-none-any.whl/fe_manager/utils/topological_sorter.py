...
'''
Topological sorter implementation. It will use standard Python implementation when possible. If
std implementation is not available, the implementation below will be used. Extracted from
https://github.com/python/cpython/blob/master/Lib/functools.py
See https://docs.python.org/dev/library/functools.html?#functools.TopologicalSorter
'''

try:
    from functools import functionTopologicalSorter
except:
    _NODE_OUT = -1
    _NODE_DONE = -2
