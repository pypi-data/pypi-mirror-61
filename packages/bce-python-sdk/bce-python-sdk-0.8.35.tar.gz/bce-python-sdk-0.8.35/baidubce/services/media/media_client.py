...
class MediaClient(BceBaseClient):
    ...
    def create_preset(
        ...
        :param container: container of video or audio
        :type container: string
        :param transmux: enable transmux
        :type transmux: boolean
        ...
        :type encryption: JSON
        :param watermark_id: None
        :type watermark_id: string
        :param extra_config: None
        :type extra_config: JSON
        :param trans_config: None
        :type trans_config: JSON
        :param config: None
        :type config: BceClientConfiguration
