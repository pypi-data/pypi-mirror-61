...
class ChartPosition(Model):
    ...
    def __init__(self, *, manager_id: str, id: int=None, name: str=None, friendly_manager_id: str=None, position: str=None, is_temp_position: bool=None, expire_date=None, unique_id: str=None, view_item: str=None, picture_url: str=None, is_department: bool=None, department_title: str=None, department_text: str=None, **kwargs) -> None:
