...
from .db import setup_db, create_indexes
...
def create_app(env_path=None) -> FastAPI:
    ...
    app.add_event_handler("startup", functools.partial(start_app, app))
    app.add_event_handler("shutdown", functools.partial(stop_app, app))
