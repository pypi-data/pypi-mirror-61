...
id = "71e3b444b6d6cab938661a7d0ff8ed66ee9264cd"
date = "2020-02-20 00:50:43 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "71e3b444b6d6cab938661a7d0ff8ed66ee9264cd":
        return
    msg = "Program id (71e3b444b6d6cab938661a7d0ff8ed66ee9264cd) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
