...
id = "735f97de90cdb9868dc5a100328e8d7d74fa220d"
date = "2020-02-8 17:59:22 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "735f97de90cdb9868dc5a100328e8d7d74fa220d":
        return
    msg = "Program id (735f97de90cdb9868dc5a100328e8d7d74fa220d) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
