import os, subprocess, time,logging,select,threading
...
def cleanupName(n):
    return n.replace("/","slash").replace("\\","backslash").replace(":",".").replace('"','')
...
print(downloadVideo('ytsearch:"pokemon master quest"', timeout=70))