...
class Qarman(KaitaiStruct):
    ...
    class AdcsPayloadT(KaitaiStruct):
        ...
        def _read(self):
            self.adcs_state = self._io.read_bits_int(2)
            self.attitude_estimation_mode = self._io.read_bits_int(3)
            self.control_mode = self._io.read_bits_int(3)
            self.cube_control_3v3_current = self._io.read_bits_int(16)
            self.cube_control_5v_current = self._io.read_bits_int(16)
            self.cube_control_vbat_current = self._io.read_bits_int(16)
            self.magnetorquer_current = self._io.read_bits_int(16)
            self.momentum_wheel_current = self._io.read_bits_int(16)
            self.magnetic_field_x = self._io.read_bits_int(16)
            self.magnetic_field_y = self._io.read_bits_int(16)
            self.magnetic_field_z = self._io.read_bits_int(16)
            self.y_angular_rate = self._io.read_bits_int(16)
            self.y_wheel_speed = self._io.read_bits_int(16)
            self.estimated_roll_angle = self._io.read_bits_int(16)
            self.estimated_pitch_angle = self._io.read_bits_int(16)
            self.estimated_yaw_angle = self._io.read_bits_int(16)
            self.estimated_x_angular_rate = self._io.read_bits_int(16)
            self.estimated_y_angular_rate = self._io.read_bits_int(16)
            self.estimated_z_angular_rate = self._io.read_bits_int(16)
            self.temperature_adcs_arm_cpu = self._io.read_bits_int(16)
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == u"ON05BE":
                self.data_payload = self._root.QarmanPayloadT(self._io, self, self._root)
    ...
    class EpsPayloadT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.temperature_obc = self._io.read_bits_int(12)
            self.battery_current = self._io.read_bits_int(10)
            self.reg_bus_3v3_current = self._io.read_bits_int(10)
            self.reg_bus_5v0_current = self._io.read_bits_int(10)
            self.temperature_uhf = self._io.read_bits_int(16)
            self.obc_mode = self._io.read_bits_int(4)
            self.reason_for_mode_change = self._io.read_bits_int(3)
            self.obc_uptime = self._io.read_bits_int(32)
            self.obc_boot_counter = self._io.read_bits_int(8)
            self.obc_packet_counter = self._io.read_bits_int(16)
            self.obc_tc_frm_received = self._io.read_bits_int(8)
            self.obc_tc_valid = self._io.read_bits_int(8)
            self.systems_on = self._io.read_bits_int(26)
            self.deployable_status = self._io.read_bits_int(13)
            self.solar_panel_current_posxi = self._io.read_bits_int(10)
            self.solar_panel_current_posxo = self._io.read_bits_int(10)
            self.solar_panel_current_negyi = self._io.read_bits_int(10)
            self.solar_panel_current_negyo = self._io.read_bits_int(10)
            self.solar_panel_current_negxi = self._io.read_bits_int(10)
            self.solar_panel_current_negxo = self._io.read_bits_int(10)
            self.solar_panel_current_posyi = self._io.read_bits_int(10)
            self.solar_panel_current_posyo = self._io.read_bits_int(10)
            self.solar_panel_voltage_posx = self._io.read_bits_int(10)
            self.solar_panel_voltage_negy = self._io.read_bits_int(10)
            self.solar_panel_voltage_negx = self._io.read_bits_int(10)
            self.solar_panel_voltage_posy = self._io.read_bits_int(10)
    ...
    class LpBeaconT(KaitaiStruct):
        ...
        def _read(self):
            self.eps_payload = self._root.EpsPayloadT(self._io, self, self._root)
    ...
    class QarmanPayloadT(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == 55:
                self.mode = self._root.LpBeaconT(self._io, self, self._root)
            elif _on == 90:
                self.mode = self._root.FullBeaconT(self._io, self, self._root)
    ...
    class FullBeaconT(KaitaiStruct):
        ...
        def _read(self):
            self.eps_payload = self._root.EpsPayloadT(self._io, self, self._root)
            self.adcs_payload = self._root.AdcsPayloadT(self._io, self, self._root)
